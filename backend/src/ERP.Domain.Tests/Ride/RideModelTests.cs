...
{
    private static RideHeader ValidHeader() => RideHeader.Create(
        environment: "2",
        emissionType: "1",
        documentTypeCode: "01",
        establishment: "001",
    ...
    private static RideParty Issuer() => RideParty.Create(
    ...
    private static RideParty Receiver() => RideParty.Create(
        identificationType: "05",
        identificationNumber: "1712345678",
        legalName: "Juan Pérez",
        address: "Calle Falsa 123");

    private static RideLine OneLine() => RideLine.Create(
        code: "PROD-001",
