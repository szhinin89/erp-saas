...
public sealed class RideInvoiceStrategyBoundaryTests
{
    ...
    public void InvoiceRideXmlParser_does_not_depend_on_infrastructure()
    {
        var result = Types.InAssembly(ApplicationAssembly)
            .That().HaveNameStartingWith("InvoiceRideXmlParser")
    ...
    {
        var result = Types.InAssembly(ApplicationAssembly)
            .That().HaveNameStartingWith("DefaultInvoiceRideTemplate")
    ...
    public void RidePipeline_still_does_not_depend_on_the_invoice_parser()
    {
        ...
        var result = Types.InAssembly(ApplicationAssembly)
            .That().HaveNameStartingWith("RidePipeline")
            .ShouldNot().HaveDependencyOn("ERP.Application.Modules.Ride.Parsers.InvoiceRideXmlParser")
            .GetResult();
    ...
    public void RidePipeline_still_does_not_depend_on_the_invoice_template()
    {
        var result = Types.InAssembly(ApplicationAssembly)
            .That().HaveNameStartingWith("RidePipeline")
            .ShouldNot().HaveDependencyOn("ERP.Application.Modules.Ride.Templates.DefaultInvoiceRideTemplate")
            .GetResult();
