...
public sealed class RideStorageAndCacheBoundaryTests
{
    ...
    public void Storage_does_not_depend_on_questpdf()
    {
        var result = Types.InAssembly(InfrastructureAssembly)
            .That().ResideInNamespace(StorageNamespace)
    ...
    public void Cache_does_not_depend_on_infrastructure_rendering()
    {
        var result = Types.InAssembly(ApplicationAssembly)
            .That().ResideInNamespace(CacheServicesNamespace)
            .ShouldNot().HaveDependencyOn("ERP.Infrastructure.Ride.Rendering")
            .GetResult();
    ...
    {
        var result = Types.InAssembly(InfrastructureAssembly)
            .That().ResideInNamespace(BrandingNamespace)
