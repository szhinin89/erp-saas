...
public sealed class PostgreSqlSecurityIntegrationTests : IAsyncLifetime
{
    ...
    public async Task PG_unique_business_partner_identification_enforced()
    {
        ...
        var bp1 = BusinessPartner.Create(tenantId, "04", "1790016919001", PersonType.Legal, "Empresa A", userId);
        db.BusinessPartners.Add(bp1);
        await db.SaveChangesAsync();

        var bp2 = BusinessPartner.Create(tenantId, "04", "1790016919001", PersonType.Legal, "Empresa B", userId);
