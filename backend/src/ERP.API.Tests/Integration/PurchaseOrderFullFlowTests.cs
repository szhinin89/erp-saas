...
/// </summary>
public sealed class PurchaseOrderFullFlowTests
{
    [Fact]
    public async Task Flujo_completo_dos_productos_vinculacion_parcial_luego_cierre()
    {
        ...
        var enviar = await mediator.Send(new SendPurchaseOrderCommand(oc.Id), CancellationToken.None);
        ...
        var aprobar = await mediator.Send(new ApprovePurchaseOrderCommand(oc.Id), CancellationToken.None);
        aprobar.IsSuccess.Should().BeTrue(aprobar.Error);
        aprobar.Value!.Status.Should().Be("Approved");

        // Ã¢â€â‚¬Ã¢â€â‚¬ PASO 4: salesBill 1 Ã¢â‚¬â€ A:6 uds, B:5 uds (parcial en A, total en B) Ã¢â€â‚¬Ã¢â€â‚¬
        ...
        // Verificar lines vÃƒÂ­a GetById
        ...
        // Ã¢â€â‚¬Ã¢â€â‚¬ PASO 5: salesBill 2 Ã¢â‚¬â€ A:4 uds (completa el pedido de A) Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
