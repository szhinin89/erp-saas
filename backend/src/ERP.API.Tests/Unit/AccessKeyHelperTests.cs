...
public sealed class AccessKeyHelperTests
{
    ...
    public void CalcularDigitoVerificador_con_todos_ceros_retorna_cero()
    {
        ...
        AccessKeyHelper.CalcularDigitoVerificador(clave48).Should().Be(0);
    }
    ...
    {
        AccessKeyHelper.CalcularDigitoVerificador(clave48).Should().Be(esperado);
    }

    [Fact]
    public void CalcularDigitoVerificador_lanza_si_clave_no_tiene_48_digitos()
    {
        var acto = () => AccessKeyHelper.CalcularDigitoVerificador("123");
    ...
    public void Generar_clave_tiene_digito_verificador_correcto()
    {
        ...
        var digitoCalc = AccessKeyHelper.CalcularDigitoVerificador(clave48);
    ...
    public void Generar_embebe_fecha_en_formato_ddMMyyyy()
    {
        ...
        var clave = AccessKeyHelper.Generar("9999999999999", 1, "001", "001", 1, "000000001", fecha);
    ...
    {
        var clave = AccessKeyHelper.Generar("9999999999999", 1, "001", "001", 1, "000000001", new DateTime(2026, 5, 9));
    ...
    public void Generar_llamadas_distintas_producen_claves_distintas_por_codigo_numerico()
    {
        ...
        var claves = Enumerable.Range(0, 20)
            .Select(_ => AccessKeyHelper.Generar(ruc, amb, estab, pto, tipo, seq, fecha))
            .Distinct()
            .Count();
    ...
    {
        var clave = AccessKeyHelper.Generar("1234567", 1, "001", "001", 1, "000000001", new DateTime(2026, 5, 9));
