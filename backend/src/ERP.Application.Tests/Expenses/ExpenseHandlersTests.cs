...
public sealed class ExpenseHandlersTests
{
    ...
    public async Task Crear_manual_total_menor_umbral_queda_en_borrador()
    {
        ...
        var parser = new Mock<IXmlInvoiceParser>();
    ...
    public async Task Crear_xml_parsea_y_guarda_borrador_con_total_sobre_umbral()
    {
        ...
        var parsed = new InvoiceParseResult(
            ...
            VatTotal: 48m,
            Total: 448m,
            Items: new[] { new InvoiceLineItem("X", "Servicio cloud", 1m, 400m, 0m, 400m) });
    ...
    public async Task Validar_y_aprobar_gasto_llama_contabilidad_y_marca_aprobado()
    {
        ...
        accounting.Setup(x => x.CreateExpenseJournalEntryAsync(
                gasto.Id,
                gasto.Category,
                It.IsAny<string>(),
                gasto.IssueDate,
        ...
        accounting.Verify(x => x.CreateExpenseJournalEntryAsync(
            gasto.Id,
            gasto.Category,
            It.IsAny<string>(),
            gasto.IssueDate,
