...
public sealed class CreateItemCommandValidatorTests
{
    ...
    public void CategoryNodeId_vacio_es_invalido()
    {
        ...
        result
            .Errors.Should()
            .Contain(e => e.PropertyName == nameof(CreateItemCommand.CategoryNodeId));
    }
    ...
    public void Dos_barcodes_principales_es_invalido()
    {
        ...
        result
            .Errors.Should()
            .Contain(e => e.ErrorMessage.Contains("exactamente un código de barras"));
    }

    [Fact]
    public void Ningun_barcode_principal_es_invalido()
    {
        var cmd = ValidCommand(barcodes: [new CreateItemBarcodeDto("111", "EAN13", false)]);
    ...
    {
        var cmd = ValidCommand(
            supplierCodes: [new CreateItemSupplierCodeDto(Guid.Empty, "SUP-1", false)]
        );
    ...
    public void BaseSalePrice_negativo_es_invalido()
    {
        ...
        result
            .Errors.Should()
            .Contain(e => e.PropertyName == nameof(CreateItemCommand.BaseSalePrice));
    }
