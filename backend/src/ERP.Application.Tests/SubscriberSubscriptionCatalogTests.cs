...
public sealed class SubscriberSubscriptionCatalogTests
{
    ...
    [Fact]
    public async Task SubscriberAllowsPermissionAsync_sales_when_sales_enabled()
    {
        var subscriberId = Guid.NewGuid();
        var entitlements = new Mock<ISubscriberEntitlementsService>(MockBehavior.Strict);
        entitlements
        ...
        (await SubscriberSubscriptionCatalog.SubscriberAllowsPermissionAsync(
    ...
    [Fact]
    public async Task SubscriberAllowsPermissionAsync_inventory_denied_without_module()
    {
        var subscriberId = Guid.NewGuid();
        var entitlements = new Mock<ISubscriberEntitlementsService>(MockBehavior.Strict);
        entitlements
    ...
    [Fact]
    public async Task SubscriberAllowsPermissionAsync_delegates_to_entitlements()
    {
        var subscriberId = Guid.NewGuid();
        var entitlements = new Mock<ISubscriberEntitlementsService>(MockBehavior.Strict);
        entitlements
    ...
    [Fact]
    public async Task SubscriberAllowsPermissionAsync_unknown_permission_prefix_always_true()
    {
        var subscriberId = Guid.NewGuid();
        var entitlements = new Mock<ISubscriberEntitlementsService>(MockBehavior.Strict);
    ...
    [Fact]
    public async Task SubscriberAllowsPermissionAsync_subscriber_account_permissions_always_true_without_saas_module()
    {
        var subscriberId = Guid.NewGuid();
        var entitlements = new Mock<ISubscriberEntitlementsService>(MockBehavior.Strict);
        entitlements
    ...
    [Fact]
    public async Task SubscriberAllowsPermissionAsync_respects_enabled_modules()
    {
        var subscriberId = Guid.NewGuid();
        var entitlements = new Mock<ISubscriberEntitlementsService>(MockBehavior.Strict);
        entitlements
