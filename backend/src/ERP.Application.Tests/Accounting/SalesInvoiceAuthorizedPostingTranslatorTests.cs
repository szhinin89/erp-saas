...
public sealed class SalesInvoiceAuthorizedPostingTranslatorTests
{
    ...
    private static SalesInvoiceAuthorizedEvent Event(DateOnly? issueDate = null, Guid? invoiceId = null) => new(
        invoiceId ?? Guid.NewGuid(), "001-001-000000001", 115m, UserId, CashSessionId,
        TenantId, CompanyId, issueDate ?? new DateOnly(2026, 7, 25),
        100m, 15m, 0m, 0m);
    ...
    private sealed class Mocks
    {
        ...
        public SalesInvoiceAuthorizedPostingTranslator BuildTranslator() => new(PostingEngine.Object, Logger.Object);
    ...
    public async Task Evento_con_datos_incompletos_falla_correctamente()
    {
        ...
        var evt = new SalesInvoiceAuthorizedEvent(
            Guid.NewGuid(), "001-001-000000009", 10m, UserId, CashSessionId,
            TenantId, Guid.Empty, default,
            10m, 0m, 0m, 0m);
