...
/// <summary>Fase 5.6.3 — CollectionAppliedPostingTranslator (Fase 5.6.1).</summary>
public sealed class CollectionAppliedPostingTranslatorTests
{
    ...
    private static CollectionAppliedEvent Event(DateOnly? paymentDate = null, Guid? paymentId = null) => new(
        TenantId, paymentId ?? Guid.NewGuid(), CompanyId, CustomerId, 150m, paymentDate ?? new DateOnly(2026, 7, 25));
    ...
    private sealed class Mocks
    {
        ...
        public CollectionAppliedPostingTranslator BuildTranslator() => new(PostingEngine.Object, Logger.Object);
    ...
    public async Task Evento_valido_construye_PostingFact_correcto()
    {
        ...
        captured.FactType.Should().Be("CollectionApplied");
