...
public sealed class CollectionReversedPostingTranslatorTests
{
    ...
    private static CollectionReversedEvent Event(Guid? paymentId = null) => new(
        TenantId, paymentId ?? Guid.NewGuid(), CompanyId, CustomerId, 150m, "Error de digitación");
    ...
    private sealed class Mocks
    {
        ...
        public CollectionReversedPostingTranslator BuildTranslator() => new(PostingEngine.Object, Logger.Object);
