...
public sealed class GetPurchaseReceptionLineMatchHandlerTests
{
    ...
    )
    {
        ...
        documentRepo
            .Setup(r => r.GetByLineIdAsync(TenantId, lineId, It.IsAny<CancellationToken>()))
        ...
        return new GetPurchaseReceptionLineMatchHandler(
            documentRepo.Object,
            matchFinder.Object,
            tenant.Object
        );
    ...
    public async Task Handle_returns_the_current_status_of_a_resolved_line_without_calling_the_match_finder()
    {
        ...
        var result = await handler.Handle(
            new GetPurchaseReceptionLineMatchQuery(line.Id),
    ...
    public async Task Handle_returns_not_found_when_the_line_does_not_exist()
    {
        ...
        var result = await handler.Handle(
            new GetPurchaseReceptionLineMatchQuery(Guid.NewGuid()),
            CancellationToken.None
        );
