...
using ERP.Infrastructure.Platform.Observability;
...
public static class DependencyInjection
{
        ...
        IConfiguration configuration)
    {
        ...
        services.AddSingleton<LegacyUsageTelemetryChannel>();
        services.AddSingleton<ILegacyUsageTelemetryChannel>(sp => sp.GetRequiredService<LegacyUsageTelemetryChannel>());
        services.AddScoped<ILegacyUsageTelemetryStore, LegacyUsageTelemetryStore>();
        services.AddSingleton<ILegacyEndpointUsageTracker, PersistentLegacyUsageTracker>();
        services.AddHostedService<LegacyUsageTelemetryWorker>();
