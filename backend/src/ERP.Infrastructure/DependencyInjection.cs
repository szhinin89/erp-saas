...
public static class DependencyInjection
{
        ...
        IConfiguration configuration)
    {
        ...
        services.AddScoped<ISupplierRepository, ProveedorRepository>();
        ...
        services.AddScoped<IPurchBillRepository, CompraRepository>();
        services.AddScoped<IExpenseInvoiceRepository, ExpenseInvoiceRepository>();
        services.AddScoped<IStockRepository, InventarioStockRepository>();
        ...
        services.AddScoped<IStockTransferRepository, TransferenciaRepository>();
        services.AddScoped<IStockAdjustmentRepository, StockAdjustmentRepository>();
        services.AddScoped<IPurchaseOrderRepository, OrdenCompraRepository>();
        ...
        services.AddScoped<ISriSettingsRepository, ConfiguracionSRIRepository>();
        services.AddScoped<IRetentionSettingsRepository, RetentionSettingsRepository>();
        services.AddScoped<ISalesRepository, VentasRepository>();
