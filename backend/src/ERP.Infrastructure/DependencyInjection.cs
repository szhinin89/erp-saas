...
public static class DependencyInjection
{
        ...
        IConfiguration configuration)
    {
        ...
        services.AddSingleton<ERP.Application.Common.Interfaces.SRI.ISriCertificateInspector,
        ...
        services.AddScoped<ERP.Application.Common.Interfaces.SRI.ISriConnectivityChecker,
            ERP.Infrastructure.Services.Sri.SriConnectivityChecker>();
        services.AddScoped<IRefreshTokenRepository, RefreshTokenRepository>();
        services.AddScoped<RefreshTokenRateLimiter>();
        services.AddScoped<IRefreshTokenService, RefreshTokenService>();
        services.AddScoped<ERP.Application.Common.Interfaces.IUserAccessRevocationService,
        ...
        services.AddScoped<ICurrentCashSession, ERP.Infrastructure.Services.CurrentCashSessionService>();
        ...
        services.AddScoped<ERP.Application.Modules.Companies.ICompanyAccessGuard, CompanyAccessGuard>();
        services.AddScoped<ERP.Application.Modules.Branches.IBranchAccessGuard, BranchAccessGuard>();
        services.AddScoped<ERP.Application.Modules.Branches.IInterBranchAccessGuard, InterBranchAccessGuard>();
        services.AddScoped<ERP.Application.Modules.Caja.ICashRegisterUsageGuard, CashRegisterUsageGuard>();
        services.AddScoped<ICompanyRepository, CompanyRepository>();
        services.AddScoped<ICurrentUser, CurrentUserService>();

        // ── Media ─────────────────────────────────────────────────────────────
        services.AddScoped<IFileStorage, LocalFileStorage>();
        services.AddScoped<ERP.Domain.Modules.Media.Interfaces.IMediaFileRepository,
            ERP.Infrastructure.Persistence.Repositories.MediaFileRepository>();
        services.AddScoped<ERP.Application.Modules.Media.IImageValidationService,
            ERP.Application.Modules.Media.ImageValidationService>();
        services.AddScoped<ERP.Application.Modules.Media.IMediaService,
            ERP.Application.Modules.Media.MediaService>();
        // ── SRI Catalog Resolver (cross-module) ───────────────────────────────
        services.AddScoped<ERP.Application.Common.ISriCatalogResolver,
            ERP.Infrastructure.Persistence.Catalogs.SriCatalogResolver>();
        services.AddScoped<ERP.Application.Common.Services.ISriDocTypeCatalogResolver,
        ...
        services.AddScoped<ERP.Domain.Modules.Items.Interfaces.ICategoryNodeRepository,
        ...
        services.AddScoped<ERP.Domain.Modules.Items.Interfaces.IItemTypeRepository,
            ERP.Infrastructure.Persistence.Repositories.Items.ItemTypeRepository>();

        services.AddScoped<IAccessRepository, AccessRepository>();
        services.AddScoped<ERP.Domain.Access.Interfaces.IUserSessionRepository,
            ERP.Infrastructure.Persistence.Repositories.UserSessionRepository>();
        services.AddScoped<ERP.Domain.Access.Interfaces.ICompanyUserBranchRepository,
            ERP.Infrastructure.Persistence.Repositories.CompanyUserBranchRepository>();
        services.AddScoped<ERP.Domain.Access.Interfaces.ICompanyUserPreferencesRepository,
        ...
        services.AddScoped(typeof(ERP.Application.Audit.IAuditReader<>), typeof(ERP.Infrastructure.Audit.EfAuditReader<>));
        services.AddScoped<ERP.Application.Audit.IAuditContext, ERP.Infrastructure.Audit.HttpAuditContext>();
        ...
        services.AddSingleton<ERP.Application.Codes.IQrCodeGenerator, ERP.Infrastructure.Codes.QrCodeGenerator>();
        services.AddSingleton<ERP.Application.Codes.Barcodes.IBarcodeGenerator,
        ...
        services.AddScoped<ERP.Domain.Modules.Pricing.Interfaces.IPricingRuleRepository,
        ...
        services.AddScoped<ERP.Application.Modules.ElectronicDocuments.Services.IElectronicDocumentDataProviderResolver,
            ERP.Application.Modules.ElectronicDocuments.Services.ElectronicDocumentDataProviderResolver>();
        services.AddScoped<ERP.Application.Modules.ElectronicDocuments.Services.IElectronicDocumentDataProvider,
        ...
        services.AddScoped<ERP.Application.Modules.Sales.Services.ISalesInvoiceEmissionStrategy,
        ...
        services.AddScoped<ERP.Application.Modules.Sales.Services.ISalesInvoiceEmissionStrategyResolver,
            ERP.Application.Modules.Sales.Services.SalesInvoiceEmissionStrategyResolver>();

        services.AddScoped<ERP.Application.Modules.ElectronicDocuments.Services.ISourceDocumentSummaryProviderResolver,
            ERP.Application.Modules.ElectronicDocuments.Services.SourceDocumentSummaryProviderResolver>();
        services.AddScoped<ERP.Application.Modules.ElectronicDocuments.Services.ISourceDocumentSummaryProvider,
        ...
        services.AddScoped<ERP.Application.Modules.ElectronicDocuments.XmlBuilders.IElectronicDocumentXmlBuilderResolver,
            ERP.Application.Modules.ElectronicDocuments.XmlBuilders.ElectronicDocumentXmlBuilderResolver>();
        services.AddScoped<ERP.Application.Modules.ElectronicDocuments.XmlBuilders.IElectronicDocumentXmlBuilder,
        ...
        services.AddScoped<ERP.Application.Modules.ElectronicDocuments.XmlBuilders.ISriTaxCategoryCodeResolver,
            ERP.Infrastructure.Services.ElectronicDocuments.SriTaxCategoryCodeResolver>();

        services.AddScoped<ERP.Application.Modules.ElectronicDocuments.Services.IElectronicDocumentSigningService,
            ERP.Application.Modules.ElectronicDocuments.Services.ElectronicDocumentSigningService>();
        services.AddScoped<ERP.Application.Modules.ElectronicInvoicing.Services.ISriCertificateStatusResolver,
        ...
        services.AddScoped<ERP.Application.Common.Interfaces.SRI.ISriReceptionClient,
            ERP.Infrastructure.Services.Sri.SriReceptionClient>();
        services.AddScoped<ERP.Application.Modules.ElectronicDocuments.Services.IElectronicDocumentReceptionService,
        ...
        services.AddScoped<ERP.Application.Common.Interfaces.SRI.ISriAuthorizationClient,
            ERP.Infrastructure.Services.Sri.SriAuthorizationClient>();
        services.AddScoped<ERP.Application.Modules.ElectronicDocuments.Services.IElectronicDocumentAuthorizationService,
        ...
        services.AddScoped<ERP.Application.Modules.ElectronicDocuments.Services.IElectronicDocumentStorageNamingStrategy,
            ERP.Application.Modules.ElectronicDocuments.Services.ElectronicDocumentStorageNamingStrategy>();
        services.AddScoped<ERP.Application.Modules.ElectronicDocuments.Services.IElectronicDocumentXmlStorageService,
        ...
        services.AddSingleton<ERP.Application.Modules.ElectronicDocuments.SchemaValidation.IXmlSchemaProvider,
            ERP.Infrastructure.Services.ElectronicDocuments.EmbeddedXmlSchemaProvider>();
        services.AddScoped<ERP.Application.Modules.ElectronicDocuments.SchemaValidation.IElectronicDocumentSchemaValidatorResolver,
            ERP.Application.Modules.ElectronicDocuments.SchemaValidation.ElectronicDocumentSchemaValidatorResolver>();
        services.AddScoped<ERP.Application.Modules.ElectronicDocuments.SchemaValidation.IElectronicDocumentSchemaValidator,
        ...
        services.AddScoped<ERP.Domain.Modules.Pricing.Services.IPricingAdjustmentStrategy, ERP.Domain.Modules.Pricing.Services.FixedPriceStrategy>();
        services.AddScoped<ERP.Domain.Modules.Pricing.Services.IPricingAdjustmentStrategy, ERP.Domain.Modules.Pricing.Services.PercentDiscountStrategy>();
        services.AddScoped<ERP.Domain.Modules.Pricing.Services.IPricingAdjustmentStrategy, ERP.Domain.Modules.Pricing.Services.PercentMarkupStrategy>();
        services.AddScoped<ERP.Domain.Modules.Pricing.Services.IPricingAdjustmentStrategy, ERP.Domain.Modules.Pricing.Services.FixedAdjustmentStrategy>();
        services.AddScoped<ERP.Application.Modules.Pricing.Services.IPricingAdjustmentStrategyResolver,
            ERP.Application.Modules.Pricing.Services.PricingAdjustmentStrategyResolver>();
        services.AddScoped<ERP.Application.Modules.Pricing.Services.IPricingResolver,
        ...
        services.AddScoped<ERP.Domain.Modules.Ride.Interfaces.IRidePdfDocumentRepository,
            ERP.Infrastructure.Persistence.Repositories.Ride.RidePdfDocumentRepository>();

        services.AddScoped<ERP.Application.Modules.Ride.Parsers.IRideXmlParserResolver,
            ERP.Application.Modules.Ride.Parsers.RideXmlParserResolver>();
        services.AddScoped<ERP.Application.Modules.Ride.Parsers.IRideXmlParser,
            ERP.Application.Modules.Ride.Parsers.InvoiceRideXmlParser>();
        // Los demás tipos de comprobante (CreditNote, DebitNote, Retention, ShippingGuide, ...)
        // añadirán su propio IRideXmlParser aquí — nunca tocar el resolver.

        services.AddScoped<ERP.Application.Modules.Ride.Templates.IRideTemplateResolver,
            ERP.Application.Modules.Ride.Templates.RideTemplateResolver>();
        services.AddScoped<ERP.Application.Modules.Ride.Templates.IRideTemplate,
        ...
        services.AddScoped<ERP.Application.Modules.Ride.Services.IRideSourceXmlProvider,
        ...
        services.AddScoped<ERP.Application.Modules.Ride.Rendering.IRideRenderer,
        ...
        services.AddScoped<ERP.Application.Modules.Ride.Branding.IRideBrandingProvider,
            ERP.Infrastructure.Ride.Branding.OrgSettingsRideBrandingProvider>();
        services.AddScoped<ERP.Application.Modules.Ride.Storage.IRidePdfStorageNamingStrategy,
            ERP.Infrastructure.Ride.Storage.RidePdfStorageNamingStrategy>();
        services.AddScoped<ERP.Application.Modules.Ride.Storage.IRidePdfStorageService,
        ...
        services.AddScoped<ERP.Application.Modules.Ride.Qr.IRideQrCodeGenerator,
        ...
        services.AddScoped<ERP.Application.Modules.Ride.Barcodes.IRideBarcodeGenerator,
        ...
        services.AddScoped<ERP.Application.Modules.Ride.Services.IRideCacheStrategy,
            ERP.Application.Modules.Ride.Services.RideCacheStrategy>();
        services.AddScoped<ERP.Application.Modules.Ride.Services.IRideContentHasher,
        ...
        services.AddScoped<ERP.Application.Modules.Ride.Services.IRideDocumentService,
            ERP.Application.Modules.Ride.Services.RideDocumentService>();

        // ── Company BC (sequences) ───────────────────────────────────────────
        services.AddScoped<ERP.Domain.Modules.Company.Interfaces.IDocumentSequenceRepository,
            ERP.Infrastructure.Persistence.Repositories.DocumentSequenceRepository>();

        // ── Inventory BC (stock) ─────────────────────────────────────────────
        services.AddScoped<ERP.Domain.Modules.Inventory.Interfaces.IStockRepository,
            ERP.Infrastructure.Persistence.Repositories.Inventory.StockRepository>();
        services.AddScoped<ERP.Domain.Modules.Inventory.Interfaces.IStockAdjustmentRepository,
            ERP.Infrastructure.Persistence.Repositories.Inventory.StockAdjustmentRepository>();
        services.AddScoped<ERP.Domain.Modules.Inventory.Interfaces.IStockTransferRepository,
            ERP.Infrastructure.Persistence.Repositories.Inventory.StockTransferRepository>();
        services.AddScoped<ERP.Application.Common.Interfaces.IAverageCostService,
        ...
        services.AddScoped<ERP.Application.Modules.Purchases.Services.ISriTaxResolver>(
            sp => sp.GetRequiredService<ERP.Infrastructure.Persistence.Services.SriTaxResolver>());
        services.AddScoped<ERP.Application.Modules.Purchases.Services.IRetentionCodeResolver,
            ERP.Infrastructure.Persistence.Services.RetentionCodeResolver>();
        services.AddScoped<ERP.Domain.Modules.Purchases.PurchaseReception.Interfaces.IPurchaseReceptionParser,
            ERP.Infrastructure.Modules.Purchases.PurchaseReception.PurchaseInvoiceTxtParser>();
        services.AddScoped<ERP.Domain.Modules.Purchases.PurchaseReception.Interfaces.IPurchaseReceptionVerifier,
            ERP.Infrastructure.Modules.Purchases.PurchaseReception.PurchaseReceptionVerifier>();
        services.AddScoped<ERP.Domain.Modules.Purchases.PurchaseReception.Interfaces.IPurchaseReceptionDocumentRepository,
        ...
        services.AddScoped<ERP.Domain.Modules.Purchases.PurchaseReception.Interfaces.ISriReceptionXmlProvider,
        ...
        services.AddScoped<ERP.Domain.Modules.Sales.Interfaces.IPaymentMethodRepository,
            ERP.Infrastructure.Persistence.Repositories.Sales.PaymentMethodRepository>();
        services.AddScoped<ERP.Domain.Modules.Sales.Interfaces.ISalesReceivableRepository,
            ERP.Infrastructure.Persistence.Repositories.Sales.SalesReceivableRepository>();
        services.AddScoped<ERP.Application.Modules.Sales.IInvoiceItemSearchRepository,
        ...
        // ── Caja BC ──────────────────────────────────────────────────────────
        services.AddScoped<ERP.Domain.Modules.Caja.Interfaces.ICashRegisterRepository,
            ERP.Infrastructure.Persistence.Repositories.Caja.CashRegisterRepository>();
        services.AddScoped<ERP.Domain.Modules.Caja.Interfaces.ICashSessionRepository,
            ERP.Infrastructure.Persistence.Repositories.Caja.CashSessionRepository>();

        // ── Company Config ───────────────────────────────────────────────────
        services.AddScoped<ERP.Application.Modules.Companies.UseCases.DecimalConfig.IDecimalConfigRepository,
        ...
        services.AddScoped<ERP.Application.Navigation.INavigationBuilder,
        ...
        services.AddScoped<ERP.Infrastructure.Seeding.Global.IGlobalBootstrapOrchestrator,
            ERP.Infrastructure.Seeding.Global.GlobalBootstrapOrchestrator>();
        services.AddScoped<ERP.Infrastructure.Seeding.Global.IGlobalBootstrapStep,
        ...
        services.AddScoped<ERP.Domain.Modules.Inventory.Interfaces.ISerialRepository, SerialRepository>();

        // ── SRI validation ───────────────────────────────────────────────────
        services.AddScoped<ERP.Application.Common.IIdentificationUsageValidator,
            ERP.Infrastructure.Services.IdentificationUsageValidator>();

        // ── Configuration BC ──────────────────────────────────────────────────
        services.AddScoped<ERP.Domain.Configuration.Interfaces.ISriSettingsRepository, SriSettingsRepository>();
        services.AddScoped<ERP.Domain.Configuration.Interfaces.IOrgSettingsRepository,
            ERP.Infrastructure.Persistence.Repositories.Configuration.OrgSettingsRepository>();
        services.AddScoped<ERP.Domain.Configuration.Interfaces.IOrgConfigResolver, OrgConfigResolver>();

        // ── Setup BC ──────────────────────────────────────────────────────────
        services.AddScoped<ISystemSetupRepository, SystemSetupRepository>();
        services.AddScoped<ERP.Application.Setup.IFirstRunSetupService, ERP.Infrastructure.Setup.FirstRunSetupService>();
