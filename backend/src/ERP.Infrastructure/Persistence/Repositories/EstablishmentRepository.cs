...
public sealed class EstablishmentRepository : IEstablishmentRepository
{
    ...
    public Task<IReadOnlyList<Establishment>> GetByBranchAsync(Guid tenantId, Guid branchId, CancellationToken cancellationToken = default)
        => _db.Establishments
            .AsNoTracking()
    ...
    public Task<IReadOnlyList<Establishment>> GetActiveByCompanyAsync(Guid tenantId, Guid companyId, CancellationToken cancellationToken = default)
        => _db.Establishments
            .AsNoTracking()
    ...
    public Task<Establishment?> GetByIdAsync(Guid tenantId, Guid id, CancellationToken cancellationToken = default)
        => _db.Establishments
            .Include(e => e.Branch)
            .FirstOrDefaultAsync(e => e.TenantId == tenantId && e.Id == id, cancellationToken);

    public Task<Establishment?> GetMainByBranchAsync(Guid tenantId, Guid branchId, CancellationToken cancellationToken = default)
        => _db.Establishments
            .AsNoTracking()
    ...
    public Task<Establishment?> GetMainByCompanyAsync(Guid tenantId, Guid companyId, CancellationToken cancellationToken = default)
        => _db.Establishments
            .AsNoTracking()
            .FirstOrDefaultAsync(e => e.TenantId == tenantId
