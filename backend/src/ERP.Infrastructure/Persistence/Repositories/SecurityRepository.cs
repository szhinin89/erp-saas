...
public class SecurityRepository : ISecurityRepository
{
    ...
    public async Task<IReadOnlyList<SecurityAdminScopeAssignment>> GetAdminScopesAsync(
        Guid tenantId,
        CancellationToken cancellationToken = default
    ) =>
        await _context
            .SecurityAdminScopeAssignments.Where(x => x.TenantId == tenantId)
    ...
    public async Task<SecurityAdminScopeAssignment?> GetAdminScopeAsync(
        ...
        await _context.SecurityAdminScopeAssignments.FirstOrDefaultAsync(
            x =>
                x.TenantId == tenantId
    ...
    public async Task AddAsync(
        SecurityAdminScopeAssignment entity,
        CancellationToken cancellationToken = default
