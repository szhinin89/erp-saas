...
namespace ERP.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260602235901_RemoveDuplicateFieldsFromGlobalRefs")]
    partial class RemoveDuplicateFieldsFromGlobalRefs
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ERP.Domain.Billing.Entities.SubscriberBillingProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("SubscriberId")
                        .IsUnique()
                        .HasDatabaseName("ux_subscriber_billing_profiles_subscriber");

                    b.ToTable("subscriber_billing_profiles", (string)null);
                });
            ...
            modelBuilder.Entity("ERP.Domain.MasterData.Entities.CompanyBusinessPartnerSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("master_company_bp_settings", (string)null);
                });

            modelBuilder.Entity("ERP.Domain.MasterData.Entities.CustomerProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("master_customer_profiles", (string)null);
                });

            modelBuilder.Entity("ERP.Domain.MasterData.Entities.SupplierProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("master_supplier_profiles", (string)null);
                });
            ...
            modelBuilder.Entity("ERP.Domain.Products.Entities.TaxRate", b =>
                {
                    ...
                    b.Property<string>("SriIceCode")
                        .HasMaxLength(10)
                        .HasColumnType("character varying(10)")
                        .HasColumnName("sri_ice_code");

                    b.Property<string>("SriVatCode")
                        .HasMaxLength(10)
                        .HasColumnType("character varying(10)")
                        .HasColumnName("sri_vat_code");
                    ...
                    b.HasIndex("SriIceCode");

                    b.HasIndex("SriVatCode");
            ...
            modelBuilder.Entity("ERP.Domain.Products.Entities.UnitOfMeasure", b =>
                {
                    ...
                    b.Property<string>("SriUomCode")
                        .HasMaxLength(5)
                        .HasColumnType("character varying(5)")
                        .HasColumnName("sri_uom_code");
            ...
            modelBuilder.Entity("ERP.Domain.Configuration.Entities.RetentionSettings", b =>
                {
                    b.HasOne("ERP.Domain.Modules.SriCatalogs.Entities.SriRetentionCode", "SriRetentionCode")
                        .WithMany()
                        .HasForeignKey("SriCode")
                        .HasPrincipalKey("Code")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("SriRetentionCode");
                });
            ...
            modelBuilder.Entity("ERP.Domain.MasterData.Entities.CompanyBusinessPartnerSettings", b =>
                {
                    b.HasOne("ERP.Domain.MasterData.Entities.BusinessPartner", "BusinessPartner")
                        .WithMany()
                        .HasForeignKey("BusinessPartnerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ERP.Domain.MasterData.Entities.CustomerProfile", b =>
                {
                    b.HasOne("ERP.Domain.MasterData.Entities.BusinessPartner", "BusinessPartner")
                        ...
                        .HasForeignKey("ERP.Domain.MasterData.Entities.CustomerProfile", "BusinessPartnerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("ERP.Domain.MasterData.Entities.SupplierProfile", b =>
                {
                    b.HasOne("ERP.Domain.MasterData.Entities.BusinessPartner", "BusinessPartner")
                        ...
                        .HasForeignKey("ERP.Domain.MasterData.Entities.SupplierProfile", "BusinessPartnerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("ERP.Domain.Products.Entities.TaxRate", b =>
                {
                    b.HasOne("ERP.Domain.Modules.SriCatalogs.Entities.SriIceRate", "SriIceRate")
                        .WithMany()
                        .HasForeignKey("SriIceCode")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("ERP.Domain.Modules.SriCatalogs.Entities.SriVatRate", "SriVatRate")
                        .WithMany()
                        .HasForeignKey("SriVatCode")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("SriIceRate");

                    b.Navigation("SriVatRate");
                });
