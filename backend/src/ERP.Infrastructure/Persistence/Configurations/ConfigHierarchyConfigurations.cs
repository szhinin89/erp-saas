...
public sealed class ConfigGlobalConfiguration : IEntityTypeConfiguration<ConfigGlobal>
{
    public void Configure(EntityTypeBuilder<ConfigGlobal> builder)
    {
        ...
        builder
            .Property(x => x.Key)
            .HasColumnName("key")
            .HasMaxLength(ConfigGlobal.KeyMaxLength)
            .IsRequired();
        builder
            .Property(x => x.Value)
            .HasColumnName("value")
            .HasMaxLength(ConfigGlobal.ValueMaxLength)
            .IsRequired();
        builder
            .Property(x => x.DataType)
            .HasColumnName("data_type")
            .HasMaxLength(ConfigGlobal.DataTypeMaxLength)
            .IsRequired();
...
public sealed class ConfigModuleConfiguration : IEntityTypeConfiguration<ConfigModule>
{
    public void Configure(EntityTypeBuilder<ConfigModule> builder)
    {
        ...
        builder
            ...
            .HasMaxLength(ConfigModule.ModuleMaxLength)
            .IsRequired();
        builder
            .Property(x => x.Key)
            .HasColumnName("key")
            .HasMaxLength(ConfigModule.KeyMaxLength)
            .IsRequired();
        builder
            .Property(x => x.Value)
            .HasColumnName("value")
            .HasMaxLength(ConfigModule.ValueMaxLength)
            .IsRequired();
        builder
            .Property(x => x.DataType)
            .HasColumnName("data_type")
            .HasMaxLength(ConfigModule.DataTypeMaxLength)
            .IsRequired();
        builder.Property(x => x.CreatedAt).HasColumnName("created_at").IsRequired();
        builder.Property(x => x.UpdatedAt).HasColumnName("updated_at");
        builder.Property(x => x.CreatedBy).HasColumnName("created_by").IsRequired();
...
public sealed class ConfigFeatureConfiguration : IEntityTypeConfiguration<ConfigFeature>
{
    public void Configure(EntityTypeBuilder<ConfigFeature> builder)
    {
        ...
        builder
            ...
            .HasMaxLength(ConfigFeature.FeatureMaxLength)
            .IsRequired();
        builder
            .Property(x => x.Key)
            .HasColumnName("key")
            .HasMaxLength(ConfigFeature.KeyMaxLength)
            .IsRequired();
        builder
            .Property(x => x.Value)
            .HasColumnName("value")
            .HasMaxLength(ConfigFeature.ValueMaxLength)
            .IsRequired();
        builder
            .Property(x => x.DataType)
            .HasColumnName("data_type")
            .HasMaxLength(ConfigFeature.DataTypeMaxLength)
            .IsRequired();
        builder.Property(x => x.CreatedAt).HasColumnName("created_at").IsRequired();
        builder.Property(x => x.UpdatedAt).HasColumnName("updated_at");
        builder.Property(x => x.CreatedBy).HasColumnName("created_by").IsRequired();
