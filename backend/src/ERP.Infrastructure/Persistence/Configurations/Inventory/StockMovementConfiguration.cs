...
public sealed class StockMovementConfiguration : IEntityTypeConfiguration<StockMovement>
{
    public void Configure(EntityTypeBuilder<StockMovement> builder)
    {
        ...
        builder
            ...
            .HasMaxLength(StockMovement.UomCodeMaxLen)
            .IsRequired();
        builder
        ...
        builder
            .HasIndex(x => new { x.SourceDocId, x.SourceDocType })
            .HasDatabaseName("ix_stock_movements_source_doc");

        builder
            .HasIndex(x => new { x.CompanyId, x.EffectiveDate })
        ...
        builder
            .HasIndex(x => new { x.CompanyId, x.BranchId })
