...
public sealed class WarehouseConfiguration : IEntityTypeConfiguration<Warehouse>
{
    public void Configure(EntityTypeBuilder<Warehouse> builder)
    {
        ...
        builder
            .Property(x => x.Name)
            .HasColumnName("name")
            .HasMaxLength(Warehouse.NameMaxLen)
            .IsRequired();
        builder.Property(x => x.Code).HasColumnName("code").HasMaxLength(Warehouse.CodeMaxLen);
        builder
        ...
        builder.Property(x => x.Phone).HasColumnName("phone").HasMaxLength(Warehouse.PhoneMaxLen);
        builder.Property(x => x.Email).HasColumnName("email").HasMaxLength(Warehouse.EmailMaxLen);
        builder
