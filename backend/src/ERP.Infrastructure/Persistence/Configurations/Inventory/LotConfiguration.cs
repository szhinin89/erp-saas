...
public sealed class LotConfiguration : IEntityTypeConfiguration<Lot>
{
    public void Configure(EntityTypeBuilder<Lot> builder)
    {
        ...
        builder.Property(e => e.LotNumber).HasColumnName("lot_number").HasMaxLength(100).IsRequired();
        ...
        builder.Property(e => e.InitialQty).HasColumnName("initial_qty").HasColumnType("numeric(18,6)").IsRequired();
        builder.Property(e => e.CurrentQty).HasColumnName("current_qty").HasColumnType("numeric(18,6)").IsRequired();
        ...
        builder.HasIndex(e => new { e.TenantId, e.CompanyId, e.ItemId }).HasDatabaseName("ix_inv_lots_tenant_company_item");
        builder.HasIndex(e => new { e.TenantId, e.CompanyId, e.ItemId, e.LotNumber })
               .IsUnique().HasDatabaseName("uq_inv_lots_item_number");
    }
}
