...
public sealed class CashClosingCountConfiguration : IEntityTypeConfiguration<CashClosingCount>
{
    public void Configure(EntityTypeBuilder<CashClosingCount> builder)
    {
        ...
        builder.Property(x => x.DenominationValue).HasColumnName("denomination_value")
            .HasColumnType("numeric(18,2)").IsRequired();

        builder.Property(x => x.DenominationLabel).HasColumnName("denomination_label")
            .HasMaxLength(CashClosingCount.DenominationLabelMaxLen).IsRequired();
