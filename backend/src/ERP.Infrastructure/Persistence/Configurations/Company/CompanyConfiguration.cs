...
public class CompanyConfiguration : IEntityTypeConfiguration<Company>
{
    public void Configure(EntityTypeBuilder<Company> builder)
    {
        ...
        builder.Property(x => x.TaxIdentificationNumber).HasColumnName("tax_identification_number").HasMaxLength(32).IsRequired();
        builder.Property(x => x.IsTemporaryTaxIdentification).HasColumnName("is_temporary_tax_identification").HasDefaultValue(false).IsRequired();
        builder.Property(x => x.TaxIdentificationStatus)
        ...
        builder.Property(x => x.CorporateEmail).HasColumnName("corporate_email").HasMaxLength(Company.CorporateEmailMaxLen);
        builder.Property(x => x.Phone).HasColumnName("phone").HasMaxLength(20);
        builder.Property(x => x.Website).HasColumnName("website").HasMaxLength(Company.WebsiteMaxLen);
        ...
        builder.Property(x => x.BrandingConfiguration).HasColumnName("branding_configuration").HasColumnType("jsonb");
        builder.Property(x => x.ExtraLegend).HasColumnName("extra_legend").HasMaxLength(500);
        builder.Property(x => x.LanguageCode).HasColumnName("language_code").HasMaxLength(5).HasDefaultValue("es");
        builder.Property(x => x.LegalRepName).HasColumnName("legal_rep_name").HasMaxLength(200);
        builder.Property(x => x.LegalRepPosition).HasColumnName("legal_rep_position").HasMaxLength(100);
        builder.Property(x => x.LegalRepIdNumber).HasColumnName("legal_rep_id_number").HasMaxLength(20);
        builder.Property(x => x.LegalRepEmail).HasColumnName("legal_rep_email").HasMaxLength(Company.CorporateEmailMaxLen);
        ...
        builder.HasIndex(x => x.TaxIdentificationNumber).IsUnique().HasDatabaseName("uq_company_tax_identification_number");
