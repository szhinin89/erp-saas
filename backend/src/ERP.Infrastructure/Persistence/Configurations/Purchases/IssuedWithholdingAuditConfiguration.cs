...
public sealed class IssuedWithholdingAuditConfiguration : IEntityTypeConfiguration<IssuedWithholdingAudit>
{
    public void Configure(EntityTypeBuilder<IssuedWithholdingAudit> builder)
    {
        ...
        builder.Property(x => x.WithholdingNumber).HasColumnName("withholding_number").HasMaxLength(20).IsRequired();
