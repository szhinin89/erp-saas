...
public sealed class PurchaseInvoiceConfiguration : IEntityTypeConfiguration<PurchaseInvoice>
{
    public void Configure(EntityTypeBuilder<PurchaseInvoice> builder)
    {
        ...
        builder.Property(x => x.DocTypeCode).HasColumnName("doc_type_code")
            .HasMaxLength(PurchaseInvoice.DocTypeCodeMaxLen).IsRequired();
        builder.Property(x => x.InvoiceNumber).HasColumnName("invoice_number")
            .HasMaxLength(PurchaseInvoice.InvoiceNumberMaxLen).IsRequired();
        ...
        builder.Property(x => x.TaxSupportCode).HasColumnName("tax_support_code")
            .HasMaxLength(5);
        builder.Property(x => x.SriPaymentMethodCode).HasColumnName("payment_method_code")
            .HasMaxLength(PurchaseInvoice.SriPaymentMethodMaxLen);
        builder.Property(x => x.SriPaymentMethodName).HasColumnName("payment_method_name")
            .HasMaxLength(PurchaseInvoice.SriPaymentMethodNameMaxLen);

        builder.Property(x => x.SupplierName).HasColumnName("supplier_name")
            .HasMaxLength(PurchaseInvoice.SupplierNameMaxLen).IsRequired();
        builder.Property(x => x.SupplierTaxId).HasColumnName("supplier_tax_id")
            .HasMaxLength(PurchaseInvoice.SupplierTaxIdMaxLen).IsRequired();

        builder.Property(x => x.CurrencyCode).HasColumnName("currency_code")
            .HasMaxLength(PurchaseInvoice.CurrencyCodeMaxLen).IsRequired();
        ...
        builder.Property(x => x.PurchaseOrderNumber).HasColumnName("purchase_order_number")
        ...
        builder.Property(x => x.PaymentTermName).HasColumnName("payment_term_name")
            .HasMaxLength(PurchaseInvoice.PaymentTermNameMaxLen).IsRequired();
        builder.Property(x => x.PaymentTermInstallments).HasColumnName("payment_term_installments").IsRequired();
        builder.Property(x => x.PaymentTermDaysBetween).HasColumnName("payment_term_days_between").IsRequired();
        ...
        builder.Property(x => x.ConfirmedSubtotal).HasColumnName("confirmed_subtotal")
            .HasColumnType("numeric(18,2)");
        builder.Property(x => x.ConfirmedTotalTax).HasColumnName("confirmed_total_tax")
            .HasColumnType("numeric(18,2)");
        builder.Property(x => x.ConfirmedTotalDiscount).HasColumnName("confirmed_total_discount")
            .HasColumnType("numeric(18,2)");
        builder.Property(x => x.ConfirmedGrandTotal).HasColumnName("confirmed_grand_total")
            .HasColumnType("numeric(18,2)");
        ...
        builder.HasIndex(x => new { x.TenantId, x.CompanyId, x.SupplierId, x.InvoiceNumber })
            .IsUnique()
