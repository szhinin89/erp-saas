...
public sealed class PurchaseInvoiceDetailConfiguration : IEntityTypeConfiguration<PurchaseInvoiceDetail>
{
    public void Configure(EntityTypeBuilder<PurchaseInvoiceDetail> builder)
    {
        ...
        builder.Property(x => x.Description).HasColumnName("description")
            .HasMaxLength(PurchaseInvoiceDetail.DescriptionMaxLen).IsRequired();
        builder.Property(x => x.SnapshotSku).HasColumnName("snapshot_sku")
            .HasMaxLength(PurchaseInvoiceDetail.SkuMaxLen);
        builder.Property(x => x.SnapshotItemName).HasColumnName("snapshot_item_name")
            .HasMaxLength(PurchaseInvoiceDetail.ItemNameMaxLen);
        builder.Property(x => x.SnapshotSupplierCode).HasColumnName("snapshot_supplier_code")
        ...
        builder.Property(x => x.UomCode).HasColumnName("uom_code")
            ...
            .HasDefaultValue("UNIT").IsRequired();
        builder.Property(x => x.ConversionFactor).HasColumnName("conversion_factor")
            .HasColumnType("numeric(18,6)").HasDefaultValue(1m).IsRequired();
        builder.Property(x => x.QuantityInBaseUom).HasColumnName("quantity_in_base_uom")
        ...
        // ── Distributed Costs ──────────────────────────────────────────
        builder.Property(x => x.FreightAllocated).HasColumnName("freight_allocated")
            .HasColumnType("numeric(18,6)").IsRequired();
        builder.Property(x => x.OtherCostsAllocated).HasColumnName("other_costs_allocated")
            .HasColumnType("numeric(18,6)").IsRequired();

        // ── Landed Cost (frozen on Confirm) ────────────────────────────
        builder.Property(x => x.TotalLineCost).HasColumnName("total_line_cost")
            .HasColumnType("numeric(18,6)").HasDefaultValue(0m).IsRequired();
        builder.Property(x => x.LandedUnitCost).HasColumnName("landed_unit_cost")
            .HasColumnType("numeric(18,6)").HasDefaultValue(0m).IsRequired();
        builder.Property(x => x.IsFrozen).HasColumnName("is_frozen")
            .HasDefaultValue(false).IsRequired();

        // ── VAT (fiscal snapshot) ───────────────────────────────────────
        builder.Property(x => x.VatCode).HasColumnName("vat_code")
            .HasMaxLength(PurchaseInvoiceDetail.VatCodeMaxLen).IsRequired();
        ...
        builder.Property(x => x.SnapshotVatName).HasColumnName("snapshot_vat_name")
        ...
        builder.Property(x => x.IceRate).HasColumnName("ice_rate")
            .HasColumnType("numeric(5,2)").IsRequired();
        builder.Property(x => x.IceAmount).HasColumnName("ice_amount")
            .HasColumnType("numeric(18,2)").IsRequired();
        builder.Property(x => x.SnapshotIceName).HasColumnName("snapshot_ice_name")
        ...
        builder.Property(x => x.SnapshotWarehouseCode).HasColumnName("snapshot_warehouse_code")
            .HasMaxLength(PurchaseInvoiceDetail.WarehouseCodeMaxLen);

        // ── Analytic Snapshot ───────────────────────────────────────────
        builder.Property(x => x.SnapshotItemPvp).HasColumnName("snapshot_item_pvp")
            .HasColumnType("numeric(18,6)").IsRequired();
