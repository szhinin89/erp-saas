...
public sealed class PurchaseInvoiceAuditConfiguration : IEntityTypeConfiguration<PurchaseInvoiceAudit>
{
    public void Configure(EntityTypeBuilder<PurchaseInvoiceAudit> builder)
    {
        ...
        builder.Property(x => x.GrandTotal).HasColumnName("grand_total").HasColumnType("numeric(18,2)").IsRequired();

        builder.HasIndex(x => new { x.TenantId, x.SupplierId, x.OccurredAtUtc })
