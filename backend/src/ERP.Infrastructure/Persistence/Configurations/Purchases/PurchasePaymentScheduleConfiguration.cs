...
public sealed class PurchasePaymentScheduleConfiguration : IEntityTypeConfiguration<PurchasePaymentSchedule>
{
    public void Configure(EntityTypeBuilder<PurchasePaymentSchedule> builder)
    {
        ...
        builder.HasIndex(x => new { x.TenantId, x.PurchaseInvoiceId })
        ...
        builder.HasIndex(x => new { x.PurchaseInvoiceId, x.InstallmentNumber })
            .IsUnique()
