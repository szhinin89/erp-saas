...
public sealed class SalesInvoicePaymentConfiguration : IEntityTypeConfiguration<SalesInvoicePayment>
{
    public void Configure(EntityTypeBuilder<SalesInvoicePayment> builder)
    {
        ...
        builder
            ...
            .HasMaxLength(SalesInvoicePayment.CodeMaxLen)
            .IsRequired();
        builder
            .Property(x => x.PaymentMethodName)
            .HasColumnName("payment_method_name")
            .HasMaxLength(SalesInvoicePayment.NameMaxLen)
            .IsRequired();
        ...
        builder.OwnsOne(
            ...
            cd =>
            {
                ...
                cd.Property(c => c.CardBrand)
                    .HasColumnName("card_brand")
                    .HasMaxLength(PaymentCardDetail.BrandMaxLen);
                cd.Property(c => c.CardLastFour)
                    .HasColumnName("card_last_four")
                    .HasMaxLength(PaymentCardDetail.LastFourMaxLen);
                cd.Property(c => c.BankName)
                    .HasColumnName("bank_name")
                    .HasMaxLength(PaymentCardDetail.BankMaxLen);
                cd.Property(c => c.AuthorizationCode)
                    .HasColumnName("authorization_code")
                    .HasMaxLength(PaymentCardDetail.AuthCodeMaxLen);
                cd.Property(c => c.LotNumber)
                    .HasColumnName("lot_number")
                    .HasMaxLength(PaymentCardDetail.LotMaxLen);
            }
        );
        ...
        builder.OwnsOne(
            ...
            ch =>
            {
                ...
                ch.Property(c => c.BankName)
                    .HasColumnName("bank_name")
                    .HasMaxLength(PaymentChequeDetail.BankMaxLen);
                ch.Property(c => c.ChequeNumber)
                    .HasColumnName("cheque_number")
                    .HasMaxLength(PaymentChequeDetail.NumberMaxLen);
                ch.Property(c => c.HolderName)
                    .HasColumnName("holder_name")
                    .HasMaxLength(PaymentChequeDetail.HolderMaxLen);
