...
public sealed class SalesBillLineConfiguration : IEntityTypeConfiguration<SalesBillLine>
{
    public void Configure(EntityTypeBuilder<SalesBillLine> builder)
    {
        builder.ToTable("sales_bill_line");
        ...
        builder.Property(e => e.ProductCode).HasColumnName("product_code")
               ...
               .HasDefaultValue("");
        builder.Property(e => e.DiscountAmount).HasColumnName("discount_amount")
               .HasPrecision(18, 4).IsRequired().HasDefaultValue(0m);
        builder.Property(e => e.VatCode).HasColumnName("vat_code")
               .HasMaxLength(SalesBillLine.VatCodeMaxLen).IsRequired().HasDefaultValue("0");
        ...
        builder.Property(e => e.Description).HasColumnName("description").HasMaxLength(SalesBillLine.DescriptionMaxLen).IsRequired();
        builder.Property(e => e.CreatedAt).HasColumnName("created_at");
        builder.Property(e => e.UpdatedAt).HasColumnName("updated_at");
        builder.Property(e => e.CreatedBy).HasColumnName("created_by");
        builder.Property(e => e.UpdatedBy).HasColumnName("updated_by");

        builder.HasIndex(e => new { e.SubscriberId, e.SalesBillId }).HasDatabaseName("ix_sales_bill_line_subscriber_bill");
    }
}
