...
public sealed class SalesInvoiceDetailConfiguration : IEntityTypeConfiguration<SalesInvoiceDetail>
{
    public void Configure(EntityTypeBuilder<SalesInvoiceDetail> builder)
    {
        ...
        builder.Property(x => x.Description).HasColumnName("description")
            .HasMaxLength(SalesInvoiceDetail.DescriptionMaxLen).IsRequired();
        ...
        builder.Property(x => x.UomCode).HasColumnName("uom_code")
            .HasMaxLength(SalesInvoiceDetail.UomCodeMaxLen).IsRequired();
        ...
        builder.Property(x => x.VatCode).HasColumnName("vat_code")
            .HasMaxLength(SalesInvoiceDetail.VatCodeMaxLen).IsRequired();
