...
public sealed class PaymentMethodConfiguration : IEntityTypeConfiguration<PaymentMethod>
{
    public void Configure(EntityTypeBuilder<PaymentMethod> builder)
    {
        ...
        builder.Property(x => x.Code).HasColumnName("code")
            .HasMaxLength(PaymentMethod.MaxCodeLength).IsRequired();
        builder.Property(x => x.Name).HasColumnName("name")
            .HasMaxLength(PaymentMethod.MaxNameLength).IsRequired();
        ...
        builder.Property(x => x.DetailType).HasColumnName("detail_type")
            .HasConversion<string>().HasMaxLength(20).IsRequired().HasDefaultValue(PaymentMethodDetailType.None);
