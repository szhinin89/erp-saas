...
public sealed class CompanyUserPreferencesConfiguration
    : IEntityTypeConfiguration<CompanyUserPreferences>
{
    public void Configure(EntityTypeBuilder<CompanyUserPreferences> builder)
    {
        ...
        builder
            .HasIndex(x => x.CompanyUserMembershipId)
            .IsUnique()
            .HasDatabaseName("ux_company_user_preferences_membership");

        builder.HasIndex(x => x.CompanyId).HasDatabaseName("ix_company_user_preferences_company");
