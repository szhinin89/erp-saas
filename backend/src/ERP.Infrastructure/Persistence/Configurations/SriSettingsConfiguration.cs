...
public sealed class SriSettingsConfiguration : IEntityTypeConfiguration<SriSettings>
{
    public void Configure(EntityTypeBuilder<SriSettings> builder)
    {
        ...
        builder.Property(e => e.CertP12Path).HasColumnName("cert_p12_path").HasMaxLength(SriSettings.CertPathMaxLen);
        builder.Property(e => e.CertPassword).HasColumnName("cert_password").HasMaxLength(SriSettings.CertPasswordMaxLen);
        builder.Property(e => e.CertFileName).HasColumnName("cert_file_name").HasMaxLength(SriSettings.CertFileNameMaxLen);
