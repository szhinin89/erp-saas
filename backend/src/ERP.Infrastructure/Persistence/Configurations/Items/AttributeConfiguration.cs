...
public sealed class AttributeDefinitionConfiguration : IEntityTypeConfiguration<AttributeDefinition>
{
    public void Configure(EntityTypeBuilder<AttributeDefinition> builder)
    {
        ...
        builder.Property(x => x.AllowedValues).HasColumnName("allowed_values").HasColumnType("jsonb");
        ...
        builder.HasIndex(x => new { x.SubscriberId, x.GroupId, x.Code })
            .IsUnique()
            .HasDatabaseName("uq_attribute_definitions_subscriber_group_code");

        builder.HasIndex(x => new { x.SubscriberId, x.IsVariantAxis })
