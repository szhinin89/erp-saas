...
public sealed class ItemVariantAttributeConfiguration
    : IEntityTypeConfiguration<ItemVariantAttribute>
{
    public void Configure(EntityTypeBuilder<ItemVariantAttribute> builder)
    {
        ...
        builder
            .Property(x => x.AttributeDefinitionId)
        ...
        builder
            .HasIndex(x => new { x.VariantId, x.AttributeDefinitionId })
            .IsUnique()
