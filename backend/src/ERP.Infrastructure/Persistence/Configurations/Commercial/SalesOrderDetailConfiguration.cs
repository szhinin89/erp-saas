...
public sealed class SalesOrderDetailConfiguration : IEntityTypeConfiguration<SalesOrderDetail>
{
    ...
    {
        builder.ToTable("sales_order_detail");
        ...
        builder.Property(e => e.ProductNameSnapshot).HasColumnName("product_name_snapshot").HasMaxLength(SalesOrderDetail.NameMaxLen).IsRequired();
        builder.Property(e => e.SkuSnapshot).HasColumnName("sku_snapshot").HasMaxLength(SalesOrderDetail.SkuMaxLen).IsRequired();
        builder.Property(e => e.UnitNameSnapshot).HasColumnName("unit_name_snapshot").HasMaxLength(SalesOrderDetail.UnitMaxLen).IsRequired();
        ...
        builder.HasIndex(e => new { e.SubscriberId, e.SalesOrderId, e.LineNo })
            .IsUnique()
