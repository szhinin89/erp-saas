...
public class SriErrorCodeConfiguration : IEntityTypeConfiguration<SriErrorCode>
{
    public void Configure(EntityTypeBuilder<SriErrorCode> builder)
    {
        ...
        builder.HasData(
            ...
            new SriErrorCode { Code = "60",  ErrorType = "WARNING", Name = "FIRMA INVÁLIDA",                     IsActive = true },
            new SriErrorCode { Code = "65",  ErrorType = "ERROR",   Name = "AMBIENTE NO VÁLIDO",                 IsActive = true },
            new SriErrorCode { Code = "70",  ErrorType = "ERROR",   Name = "CLAVE DE ACCESO NO REGISTRADA",      IsActive = true },
            new SriErrorCode { Code = "72",  ErrorType = "ERROR",   Name = "NÚMERO DE COMPROBANTE YA EXISTE",    IsActive = true },
            new SriErrorCode { Code = "73",  ErrorType = "ERROR",   Name = "CLAVE DE ACCESO INVÁLIDA",           IsActive = true },
            new SriErrorCode { Code = "90",  ErrorType = "ERROR",   Name = "CERTIFICADO INVÁLIDO O CADUCADO",    IsActive = true },
