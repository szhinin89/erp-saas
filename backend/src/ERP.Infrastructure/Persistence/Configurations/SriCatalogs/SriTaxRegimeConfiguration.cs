...
public class SriTaxRegimeConfiguration : IEntityTypeConfiguration<SriTaxRegime>
{
    ...
    {
        builder.ToTable("sri_tax_regime", schema: "global");
        ...
        builder.HasData(
            new SriTaxRegime { Code = "01", Name = "RÃ©gimen General",                   Abbrev = "GENERAL",  IsActive = true },
            new SriTaxRegime { Code = "02", Name = "RIMPE â€“ RÃ©gimen de Microempresas",  Abbrev = "RIMPE_ME", IsActive = true },
            new SriTaxRegime { Code = "03", Name = "RIMPE â€“ Negocio Popular",           Abbrev = "RIMPE_NP", IsActive = true },
