...
public class SriUomConfiguration : IEntityTypeConfiguration<SriUom>
{
    ...
    {
        builder.ToTable("sri_uom", schema: "global");
        ...
        builder.HasData(
            new SriUom { Code = "01", Name = "Unidad BiolÃ³gica",  Abbrev = "UB"    },
            ...
            new SriUom { Code = "12", Name = "Metro cÃºbico",     Abbrev = "M3"    },
            ...
            new SriUom { Code = "20", Name = "VehÃ­culo",         Abbrev = "VEH"   },
