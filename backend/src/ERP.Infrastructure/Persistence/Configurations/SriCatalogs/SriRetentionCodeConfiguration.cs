...
public class SriRetentionCodeConfiguration : IEntityTypeConfiguration<SriRetentionCode>
{
    public void Configure(EntityTypeBuilder<SriRetentionCode> builder)
    {
        ...
        builder.HasData(
            // IVA
            new SriRetentionCode { Id = Guid.Parse("10000000-0000-0000-0000-000000000001"), TaxType = "IVA",   Code = "721",  Name = "Ret. IVA 10% â€“ Bienes (tarifa vigente)",                 Percentage = 10.00m  },
            new SriRetentionCode { Id = Guid.Parse("10000000-0000-0000-0000-000000000002"), TaxType = "IVA",   Code = "723",  Name = "Ret. IVA 20% â€“ Servicios (tarifa vigente)",              Percentage = 20.00m  },
            new SriRetentionCode { Id = Guid.Parse("10000000-0000-0000-0000-000000000003"), TaxType = "IVA",   Code = "725",  Name = "Ret. IVA 30% â€“ Presuntivo bienes",                       Percentage = 30.00m  },
            new SriRetentionCode { Id = Guid.Parse("10000000-0000-0000-0000-000000000004"), TaxType = "IVA",   Code = "726",  Name = "Ret. IVA 70% â€“ Presuntivo servicios",                    Percentage = 70.00m  },
            new SriRetentionCode { Id = Guid.Parse("10000000-0000-0000-0000-000000000005"), TaxType = "IVA",   Code = "727",  Name = "Ret. IVA 100% â€“ Liq. compra / honorarios",               Percentage = 100.00m },
            new SriRetentionCode { Id = Guid.Parse("10000000-0000-0000-0000-000000000006"), TaxType = "IVA",   Code = "728",  Name = "Ret. IVA 15% â€“ Constructoras",                           Percentage = 15.00m  },
            // RENTA
            new SriRetentionCode { Id = Guid.Parse("20000000-0000-0000-0000-000000000001"), TaxType = "RENTA", Code = "303",  Name = "Honorarios profesionales y demÃ¡s servicios",             Percentage = 10.00m  },
            new SriRetentionCode { Id = Guid.Parse("20000000-0000-0000-0000-000000000002"), TaxType = "RENTA", Code = "304",  Name = "Servicios â€“ predomina mano de obra",                     Percentage = 2.00m   },
            new SriRetentionCode { Id = Guid.Parse("20000000-0000-0000-0000-000000000003"), TaxType = "RENTA", Code = "307",  Name = "Publicidad y comunicaciÃ³n",                              Percentage = 1.75m   },
            ...
            new SriRetentionCode { Id = Guid.Parse("20000000-0000-0000-0000-000000000009"), TaxType = "RENTA", Code = "327",  Name = "Actividades de construcciÃ³n (contrato)",                  Percentage = 1.75m   },
            ...
            // ISD
            new SriRetentionCode { Id = Guid.Parse("30000000-0000-0000-0000-000000000001"), TaxType = "ISD",   Code = "4580", Name = "ISD â€“ Impuesto a la Salida de Divisas",                  Percentage = 5.00m   }
        );
    }
}
