...
public class SriCountryConfiguration : IEntityTypeConfiguration<SriCountry>
{
    ...
    {
        builder.ToTable("sri_country", schema: "global");
        ...
        builder.HasData(
            ...
            new SriCountry { Code = "PER", Iso2 = "PE", Name = "PERÃš",                  PhoneCode = "+51"  },
            ...
            new SriCountry { Code = "MEX", Iso2 = "MX", Name = "MÃ‰XICO",              PhoneCode = "+52"  },
            new SriCountry { Code = "VEN", Iso2 = "VE", Name = "VENEZUELA",             PhoneCode = "+58"  },
            new SriCountry { Code = "PAN", Iso2 = "PA", Name = "PANAMÃ",              PhoneCode = "+507" },
            ...
            new SriCountry { Code = "DOM", Iso2 = "DO", Name = "REPÃšBLICA DOMINICANA", PhoneCode = "+1"   },
            new SriCountry { Code = "URY", Iso2 = "UY", Name = "URUGUAY",              PhoneCode = "+598" },
            new SriCountry { Code = "PRY", Iso2 = "PY", Name = "PARAGUAY",             PhoneCode = "+595" },
            new SriCountry { Code = "ESP", Iso2 = "ES", Name = "ESPAÃ‘A",              PhoneCode = "+34"  },
            ...
            new SriCountry { Code = "JPN", Iso2 = "JP", Name = "JAPÃ“N",              PhoneCode = "+81"  },
            new SriCountry { Code = "CHN", Iso2 = "CN", Name = "CHINA",               PhoneCode = "+86"  },
            new SriCountry { Code = "IND", Iso2 = "IN", Name = "INDIA",               PhoneCode = "+91"  },
            new SriCountry { Code = "CAN", Iso2 = "CA", Name = "CANADÃ",             PhoneCode = "+1"   },
