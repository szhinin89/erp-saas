...
public class RefreshTokenConfiguration : IEntityTypeConfiguration<RefreshToken>
{
    public void Configure(EntityTypeBuilder<RefreshToken> builder)
    {
        ...
        builder.Property(e => e.UserType).HasColumnName("user_type").HasMaxLength(20).IsRequired();
        ...
        builder.Property(e => e.ReasonRevoked).HasColumnName("reason_revoked").HasMaxLength(50);

        builder.Property(e => e.CreatedAt).HasColumnName("created_at").IsRequired();

        builder.Property(e => e.FamilyId).HasColumnName("family_id").IsRequired();

        builder.Property(e => e.ParentTokenId).HasColumnName("parent_token_id");
        ...
        builder.HasIndex(e => e.FamilyId).HasDatabaseName("ix_refresh_tokens_family_id");

        // Índice para revocación masiva por usuario/tenant
        builder
            .HasIndex(e => new { e.UserId, e.TenantId })
