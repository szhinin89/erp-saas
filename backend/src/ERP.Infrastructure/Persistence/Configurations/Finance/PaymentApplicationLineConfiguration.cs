...
public sealed class PaymentApplicationLineConfiguration : IEntityTypeConfiguration<PaymentApplicationLine>
{
    public void Configure(EntityTypeBuilder<PaymentApplicationLine> builder)
    {
        ...
        builder.ToTable("payment_application_lines", t =>
        {
        ...
        builder.HasOne<SalesReceivable>()
            .WithMany()
            .HasForeignKey(x => x.ReceivableId)
            .OnDelete(DeleteBehavior.Restrict);

        builder.HasOne<PurchasePayable>()
            .WithMany()
        ...
        builder.HasIndex(x => x.PayableId)
