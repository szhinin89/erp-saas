...
/// </summary>
public sealed class CompanyBpTradingSettingsConfiguration
    : IEntityTypeConfiguration<CompanyBpTradingSettings>
{
    public void Configure(EntityTypeBuilder<CompanyBpTradingSettings> builder)
    {
        ...
        builder
            .Property(x => x.CreditCurrencyCode)
        ...
        builder
            .Property(x => x.Installments)
            .HasColumnName("installments")
            .IsRequired()
            .HasDefaultValue(1);

        builder
            .Property(x => x.DaysBetweenInstallments)
        ...
        builder.Property(x => x.BlockedBy).HasColumnName("blocked_by");
