    ...
    public partial class InitialEnterpriseBaseline : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_person_type", x => x.code);
                }
            );
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { (short)1, "Natural (persona física)" },
                    { (short)2, "Jurídica (empresa/sociedad)" },
                    { (short)3, "Gubernamental" },
                    { (short)4, "Organización / ONG" },
                }
            );
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(name: "person_type", schema: "global");
