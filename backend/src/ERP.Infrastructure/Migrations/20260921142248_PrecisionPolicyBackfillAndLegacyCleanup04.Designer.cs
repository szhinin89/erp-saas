...
namespace ERP.Infrastructure.Migrations
{
    ...
    [Migration("20260921142248_PrecisionPolicyBackfillAndLegacyCleanup04")]
    partial class PrecisionPolicyBackfillAndLegacyCleanup04
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ERP.Domain.Configuration.Entities.CompanyPrecisionPolicy", b =>
                {
                    ...
                    b.ToTable("company_precision_policy", null, t =>
                        {
                            t.HasCheckConstraint("ck_company_precision_policy_average_cost", "average_cost_decimals BETWEEN 2 AND 8");

                            t.HasCheckConstraint("ck_company_precision_policy_conversion_factor", "conversion_factor_decimals BETWEEN 2 AND 8");

                            t.HasCheckConstraint("ck_company_precision_policy_percentage", "percentage_decimals BETWEEN 2 AND 6");

                            t.HasCheckConstraint("ck_company_precision_policy_purchase_unit_price", "purchase_unit_price_decimals BETWEEN 2 AND 8");

                            t.HasCheckConstraint("ck_company_precision_policy_quantity", "quantity_decimals BETWEEN 0 AND 6");

                            t.HasCheckConstraint("ck_company_precision_policy_sales_unit_price", "sales_unit_price_decimals BETWEEN 2 AND 8");

                            t.HasCheckConstraint("ck_company_precision_policy_settlement_tolerance", "settlement_tolerance_amount BETWEEN 0.00 AND 0.02");

                            t.HasCheckConstraint("ck_company_precision_policy_unit_cost", "unit_cost_decimals BETWEEN 2 AND 8");
                        });
                });
