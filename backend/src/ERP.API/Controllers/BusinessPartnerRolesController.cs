...
/// </summary>
[ApiController]
[Route("api/master/business-partners/{bpId:guid}/roles")]
...
public sealed class BusinessPartnerRolesController : ControllerBase
{
    ...
    {
        var result = await _mediator.Send(new GetBusinessPartnerRolesQuery(bpId, onlyActive), ct);
        ...
        CancellationToken ct = default)
    {
        ...
        return result.IsSuccess
            ? this.ApiCreated(result.Value!, "Rol asignado.")
    ...
    public async Task<IActionResult> RevokeRole(
        ...
        CancellationToken ct = default)
    {
        _ = bpId; // el filtro de tenant garantiza que roleId pertenece al subscriber
        var result = await _mediator.Send(new RevokeBusinessPartnerRoleCommand(roleId), ct);
        return this.ToOkOrBadRequest(result);
    }
        ...
        CancellationToken ct = default)
    {
        ...
        var result = await _mediator.Send(new UpdateCarrierRoleConfigCommand(roleId, config), ct);
        return this.ToOkOrBadRequest(result);
    }
        ...
        CancellationToken ct = default)
    {
        ...
        var result = await _mediator.Send(new UpdateCustomerRoleConfigCommand(roleId, config), ct);
        return this.ToOkOrBadRequest(result);
    }
    ...
    {
        _ = bpId;
        var result = await _mediator.Send(new UpdateRoleNotesCommand(roleId, body.Notes), ct);
        return this.ToOkOrBadRequest(result);
    }
}
