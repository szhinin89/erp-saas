...
public sealed class PlatformPlansController : ControllerBase
{
    ...
    public PlatformPlansController(ICommercialPlansAdminService admin) => _admin = admin;

    /// <summary>Lista planes administrables con features incluidas y límites.</summary>
    [HttpGet]
    ...
    /// <summary>Obtiene el JSON de menú lateral y preferencia de layout del plan.</summary>
    ...
    /// <summary>Guarda el menú lateral del plan.</summary>
