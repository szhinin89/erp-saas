...
public sealed class PlatformScopedConfigController : ControllerBase
{
    private readonly IConfigService _configService;
    private readonly ICurrentUser _currentUser;

    public PlatformScopedConfigController(IConfigService configService, ICurrentUser currentUser)
    {
