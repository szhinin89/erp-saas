...
/// </summary>
[AppFeature("Proveedores", "perm:purchases.suppliers.view", "ðŸ­", "/purchases/suppliers", "perm:purchases.invoices.view", 46)]
[ApiController]
...
public sealed class SuppliersController : ControllerBase
{
    ...
    /// </remarks>
    [HttpGet]
    [Authorize(Policy = "perm:purchases.suppliers.view")]
    ...
    [HttpPost]
    [Authorize(Policy = "perm:purchases.suppliers.create")]
    ...
    [HttpPut("{id:guid}")]
    [Authorize(Policy = "perm:purchases.suppliers.update")]
    ...
    [Authorize(Policy = "perm:purchases.suppliers.delete")]
    [ProducesResponseType(typeof(ApiResponse<SupplierDto>), StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status400BadRequest)]
