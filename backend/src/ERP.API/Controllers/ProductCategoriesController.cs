...
using ERP.Application.Products.UseCases.CreateProductCategory;
using ERP.Application.Products.UseCases.DisableProductCategory;
using ERP.Application.Products.UseCases.EnableProductCategory;
using ERP.Application.Products.UseCases.GetProductCategories;
using ERP.Application.Products.UseCases.UpdateProductCategory;
using ERP.API.Attributes;

namespace ERP.API.Controllers;

/// <summary>Catálogo maestro: Categorías de producto (dependen de una línea).</summary>
[AppFeature("Categorías", "perm:inventory.categories.view", "📁", "/inventory/catalog-structure", "perm:inventory.products.view", 39)]
[ApiController]
...
public class ProductCategoriesController : ControllerBase
{
    ...
    [HttpGet]
    [Authorize(Policy = "perm:inventory.categories.view")]
    ...
    [HttpPost]
    [Authorize(Policy = "perm:inventory.categories.create")]
    ...
    [HttpPut("{id:guid}")]
    [Authorize(Policy = "perm:inventory.categories.update")]
    [ProducesResponseType(StatusCodes.Status422UnprocessableEntity)]
    ...
    [Authorize(Policy = "perm:inventory.categories.delete")]
