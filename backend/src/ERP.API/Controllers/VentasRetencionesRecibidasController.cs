...
[Modulo("Retenciones recibidas", "perm:ventas.retenciones-recibidas.list", "ðŸ“‹", "/ventas/retenciones-recibidas", "perm:ventas.facturas.view", 53)]
[ApiController]
...
public sealed class SalesReceivedWithholdingsController : ControllerBase
{
    ...
    public async Task<IActionResult> Registrar([FromBody] RegistrarSalesRetentionCommand command, CancellationToken ct = default)
    {
