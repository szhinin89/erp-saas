...
{
    public static (bool Ok, Guid ProductId, Guid WarehouseId, DateTime? StartDate, DateTime? EndDate, IActionResult? Error)
        Parse(IQueryCollection query)
    {
        ...
        var (startDate, endDate) = ListQueryParameters.ParseDateTimeRange(query, "fechaInicio", "fechaFin");
