...
public sealed class AssignBusinessPartnerRoleValidator
    : AbstractValidator<AssignBusinessPartnerRoleCommand>
{
    public AssignBusinessPartnerRoleValidator()
    {
        ...
        RuleFor(x => x.RoleType).IsInEnum().WithMessage("Tipo de rol inválido.");
    }
}
