    ...
    : IRequestHandler<BlockBusinessPartnerCommand, Result<bool>>
{
    ...
    public async Task<Result<bool>> Handle(BlockBusinessPartnerCommand cmd, CancellationToken cancellationToken)
    {
        ...
        await _activity.AddAsync(UserActivity.Create(
            ...
            module: "masterdata", action: "business-partner.block",
            entityType: "BusinessPartner", entityId: cmd.BusinessPartnerId,
            description: $"BP bloqueado. Motivo: {cmd.Reason}"), cancellationToken);
