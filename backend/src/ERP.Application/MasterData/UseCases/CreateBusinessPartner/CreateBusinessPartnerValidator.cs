...
public sealed class CreateBusinessPartnerValidator : AbstractValidator<CreateBusinessPartnerCommand>
{
    ...
    [
        ...
        TaxIdentification.SriCi,
        TaxIdentification.SriPassport,
        TaxIdentification.SriConsumidorFinal,
        TaxIdentification.SriExterior,
        TaxIdentification.SriPlaca,
    ];
    ...
    public CreateBusinessPartnerValidator()
    {
        RuleFor(x => x.IdentificationType)
            ...
            .WithMessage(
                "Tipo de identificación inválido. Use: 04=RUC, 05=CI, 06=Pasaporte, 07=ConsumidorFinal, 08=Exterior, 09=Placa."
            );
        ...
        RuleFor(x => x.IdentificationNumber)
            ...
            .WithMessage(
                $"El número no puede superar {TaxIdentification.NumberMaxLen} caracteres."
            );
        ...
        // Obligatoriedad condicional (solo si no puede inferirse de la identificación) y
