...
/// Cuando no hay fila de <c>ConfiguracionContableEmpresa</c>, los métodos de compra/venta devuelven éxito con valor null
...
public interface ICuentaContableService
{
    ...
    Task<Result<Guid?>> ObtenerCuentaParaGastoAsync(Guid tenantId, string categoriaGasto, CancellationToken ct);
