...
/// </summary>
public sealed class SalesInvoiceAuthorizedPostingTranslator : INotificationHandler<SalesInvoiceAuthorizedEvent>
{
    ...
    public SalesInvoiceAuthorizedPostingTranslator(
        IPostingEngine postingEngine, ILogger<SalesInvoiceAuthorizedPostingTranslator> logger)
    {
