...
public sealed class UploadSriCertificateCommandValidator : AbstractValidator<UploadSriCertificateCommand>
{
    ...
    {
        RuleFor(x => x.File)
            .NotNull().WithMessage("Debe adjuntar el archivo del certificado.");
