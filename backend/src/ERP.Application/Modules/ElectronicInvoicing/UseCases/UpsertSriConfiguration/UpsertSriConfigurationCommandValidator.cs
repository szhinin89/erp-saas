...
public sealed class UpsertSriConfigurationCommandValidator
    : AbstractValidator<UpsertSriConfigurationCommand>
{
    public UpsertSriConfigurationCommandValidator()
    {
        ...
        RuleFor(x => x.CertPassword).MaximumLength(SriSettings.CertPasswordMaxLen);
        ...
        RuleFor(x => x.WsdlUrl)
            .NotEmpty()
            .WithMessage("La URL de autorización SRI es obligatoria.")
