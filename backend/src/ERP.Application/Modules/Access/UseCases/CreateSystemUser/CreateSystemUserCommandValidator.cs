...
/// <summary>Reglas de complejidad de contraseña: ver PasswordComplexityRules — misma política que
/// CreateInitialAdminCommandValidator/ChangeMyPasswordCommandValidator/ResetPasswordWithTokenCommandValidator.</summary>
public sealed class CreateSystemUserCommandValidator : AbstractValidator<CreateSystemUserCommand>
{
    public CreateSystemUserCommandValidator()
    {
        RuleFor(x => x.Username)
            ...
            .WithMessage(
                "El username debe tener 3-50 caracteres: letras, números, punto, guion o guion bajo."
            );
