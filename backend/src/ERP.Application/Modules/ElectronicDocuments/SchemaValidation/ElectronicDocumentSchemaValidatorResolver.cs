...
public sealed class ElectronicDocumentSchemaValidatorResolver
    : IElectronicDocumentSchemaValidatorResolver
{
    private readonly IReadOnlyDictionary<
        ElectronicDocumentType,
        IElectronicDocumentSchemaValidator
    > _validators;

    public ElectronicDocumentSchemaValidatorResolver(
        IEnumerable<IElectronicDocumentSchemaValidator> validators
    )
    {
