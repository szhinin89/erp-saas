        ...
        INotificationHandler<ElectronicDocumentReactivatedEvent>
{
    ...
    public Task Handle(ElectronicDocumentCreatedEvent e, CancellationToken ct) =>
        _audit.RecordAsync(
            ElectronicDocumentAudit.Create(
                ...
                e.DocumentType,
                fromState: null,
                toState: ElectronicDocumentState.Draft
            ),
            ct
        );

    public Task Handle(ElectronicDocumentXmlGeneratedEvent e, CancellationToken ct) =>
        _audit.RecordAsync(
            ElectronicDocumentAudit.Create(
                _context.Actor,
                _context.CompanyId,
    ...
    public Task Handle(ElectronicDocumentSignedEvent e, CancellationToken ct) =>
        _audit.RecordAsync(
            ElectronicDocumentAudit.Create(
                _context.Actor,
                _context.CompanyId,
    ...
    public Task Handle(ElectronicDocumentSentEvent e, CancellationToken ct) =>
        _audit.RecordAsync(
            ElectronicDocumentAudit.Create(
                _context.Actor,
                _context.CompanyId,
    ...
    public Task Handle(ElectronicDocumentReceivedEvent e, CancellationToken ct) =>
        _audit.RecordAsync(
            ElectronicDocumentAudit.Create(
                _context.Actor,
                _context.CompanyId,
    ...
    public Task Handle(ElectronicDocumentAuthorizedEvent e, CancellationToken ct) =>
        _audit.RecordAsync(
            ElectronicDocumentAudit.Create(
                _context.Actor,
                _context.CompanyId,
    ...
    public Task Handle(ElectronicDocumentRejectedEvent e, CancellationToken ct) =>
        _audit.RecordAsync(
            ElectronicDocumentAudit.Create(
                _context.Actor,
                _context.CompanyId,
    ...
    public Task Handle(ElectronicDocumentDeadLetterEvent e, CancellationToken ct) =>
        _audit.RecordAsync(
            ElectronicDocumentAudit.Create(
                _context.Actor,
                _context.CompanyId,
    ...
    public Task Handle(ElectronicDocumentCancelledEvent e, CancellationToken ct) =>
        _audit.RecordAsync(
            ElectronicDocumentAudit.Create(
                _context.Actor,
                _context.CompanyId,
    ...
    public Task Handle(ElectronicDocumentRetryAttemptedEvent e, CancellationToken ct) =>
        _audit.RecordAsync(
            ElectronicDocumentAudit.Create(
                _context.Actor,
                _context.CompanyId,
    ...
    public Task Handle(ElectronicDocumentReactivatedEvent e, CancellationToken ct) =>
        _audit.RecordAsync(
            ElectronicDocumentAudit.Create(
                _context.Actor,
                _context.CompanyId,
