...
public sealed partial class ElectronicDocumentSigningService : IElectronicDocumentSigningService
{
        ...
        Guid tenantId, Guid companyId, ElectronicDocumentXml xml, CancellationToken ct = default)
    {
        ...
        {
            LogSigningPrerequisiteMissing(companyId, "La empresa no tiene configuración SRI registrada.");
        ...
        {
            LogSigningPrerequisiteMissing(companyId, "El certificado P12 configurado no es accesible en el almacenamiento.");
        ...
        return Result<SignedElectronicDocumentXml>.Success(new SignedElectronicDocumentXml(
