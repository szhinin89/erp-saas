...
public sealed class EnableBranchCommandHandler : IRequestHandler<EnableBranchCommand, Result<BranchListItemDto>>
{
    ...
    public async Task<Result<BranchListItemDto>> Handle(EnableBranchCommand request, CancellationToken cancellationToken)
    {
