...
public sealed record DisableCashRegisterCommand(Guid Id) : IRequest<Result<bool>>, ICompanyScopedRequest;

public sealed class DisableCashRegisterHandler : IRequestHandler<DisableCashRegisterCommand, Result<bool>>
{
    ...
    public DisableCashRegisterHandler(ICashRegisterRepository repo, ICashRegisterUsageGuard usageGuard, ICurrentTenant t, ICurrentUser u)
    {
        _repo = repo; _usageGuard = usageGuard; _t = t; _u = u;
    }
