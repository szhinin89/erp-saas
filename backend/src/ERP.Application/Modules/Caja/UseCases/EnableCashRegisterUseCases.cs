...
public sealed record EnableCashRegisterCommand(Guid Id)
    : IRequest<Result<bool>>,
        ICompanyScopedRequest;

public sealed class EnableCashRegisterHandler
    : IRequestHandler<EnableCashRegisterCommand, Result<bool>>
{
