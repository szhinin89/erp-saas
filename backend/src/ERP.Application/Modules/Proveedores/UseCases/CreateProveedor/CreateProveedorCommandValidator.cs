...
namespace ERP.Application.Modules.Proveedores.UseCases.CreateProveedor;
...
public sealed class CreateProveedorCommandValidator : AbstractValidator<CreateProveedorCommand>
{
        ...
        ICurrentTenant tenant)
    {
        ...
        RuleFor(x => x.RazonSocial)
            ...
            .WithMessage($"La razón social no puede exceder {Proveedor.RazonSocialMaxLen} caracteres.");
        ...
        RuleFor(x => x.Ruc)
            ...
            .WithMessage("Ya existe un proveedor con ese RUC en el tenant.");
