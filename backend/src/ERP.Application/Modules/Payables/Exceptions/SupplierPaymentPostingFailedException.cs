...
/// cuando <c>IPostingEngine.PostAsync</c> falla o una cuenta bancaria/caja referenciada ya no es
/// postable. Mismo criterio que <c>ExpensePostingFailedException</c> (Gastos): un pago a
