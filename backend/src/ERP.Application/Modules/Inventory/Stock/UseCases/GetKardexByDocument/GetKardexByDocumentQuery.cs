...
///
/// ZH-AUTH-INVENTORY-BRANCH-READ-SCOPE-06 — <b>company-wide por diseño</b>, igual que
/// GetKardexByProductQuery: un documento (p.ej. un StockTransfer) puede generar movimientos en
/// bodegas de más de una sucursal, así que restringir por sucursal activa rompería el propósito
/// de la consulta. Aislamiento real: <c>IStockRepository.GetMovementsByDocumentAsync</c> filtra por
/// <c>ICurrentCompany</c> (nunca cruza empresas) y el endpoint exige
