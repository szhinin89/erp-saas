    ...
    : IRequestHandler<ReplaceItemImagesCommand, Result<ItemDetailDto>>
{
    ...
    public async Task<Result<ItemDetailDto>> Handle(ReplaceItemImagesCommand cmd, CancellationToken cancellationToken)
    {
    ...
    : IRequestHandler<DisableItemImageCommand, Result<bool>>
{
    ...
    public async Task<Result<bool>> Handle(DisableItemImageCommand cmd, CancellationToken cancellationToken)
    {
