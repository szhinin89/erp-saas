...
public sealed record EnableItemCommand(Guid Id) : IRequest<Result<bool>>, ICompanyScopedRequest;

public sealed class EnableItemCommandHandler : IRequestHandler<EnableItemCommand, Result<bool>>
{
