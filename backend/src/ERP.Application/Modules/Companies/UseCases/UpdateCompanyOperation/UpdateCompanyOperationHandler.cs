...
public sealed class UpdateCompanyOperationHandler
    : IRequestHandler<UpdateCompanyOperationCommand, Result<CompanyProfileDto>>
{
    private readonly ICompanyAccessGuard _accessGuard;
    private readonly ICompanyRepository _companies;
    private readonly ICurrentUser _currentUser;

    public UpdateCompanyOperationHandler(
    ...
    public async Task<Result<CompanyProfileDto>> Handle(
        UpdateCompanyOperationCommand command,
