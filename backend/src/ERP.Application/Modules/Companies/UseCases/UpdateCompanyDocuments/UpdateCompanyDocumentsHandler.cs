...
public sealed class UpdateCompanyDocumentsHandler : IRequestHandler<UpdateCompanyDocumentsCommand, Result<CompanyProfileDto>>
{
    private readonly ICompanyAccessGuard _accessGuard;
    private readonly ICompanyRepository _companies;
    private readonly ICurrentUser _currentUser;

    public UpdateCompanyDocumentsHandler(ICompanyAccessGuard accessGuard, ICompanyRepository companies, ICurrentUser currentUser)
    {
    ...
    public async Task<Result<CompanyProfileDto>> Handle(UpdateCompanyDocumentsCommand command, CancellationToken cancellationToken)
    {
