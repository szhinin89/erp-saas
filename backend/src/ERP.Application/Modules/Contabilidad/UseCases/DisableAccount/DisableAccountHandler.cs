...
public class DisableAccountHandler : IRequestHandler<DisableAccountCommand, Result<AccountDto>>
{
    ...
    public async Task<Result<AccountDto>> Handle(DisableAccountCommand command, CancellationToken ct)
    {
