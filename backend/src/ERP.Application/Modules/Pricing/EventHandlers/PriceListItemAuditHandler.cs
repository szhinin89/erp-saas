        ...
        INotificationHandler<PriceListItemDisabledEvent>
{
    ...
    public Task Handle(PriceListItemAssignedEvent e, CancellationToken ct) =>
        _audit.RecordAsync(
    ...
    public Task Handle(PriceListItemEnabledEvent e, CancellationToken ct) =>
        _audit.RecordAsync(
            PriceListItemAudit.Create(
                _context.Actor,
                _context.CompanyId,
    ...
    public Task Handle(PriceListItemDisabledEvent e, CancellationToken ct) =>
        _audit.RecordAsync(
            PriceListItemAudit.Create(
                _context.Actor,
                _context.CompanyId,
