    ...
    : IRequestHandler<GetWithholdingByIdQuery, Result<IssuedWithholdingDto>>
{
    ...
    public GetWithholdingByIdHandler(IPurchaseInvoiceRepository repo, ICurrentTenant t)
    {
        _repo = repo;
        _t = t;
    }
    ...
    : IRequestHandler<GetWithholdingByPurchaseQuery, Result<IssuedWithholdingDto?>>
{
    ...
    public GetWithholdingByPurchaseHandler(IPurchaseInvoiceRepository repo, ICurrentTenant t)
    {
        _repo = repo;
        _t = t;
    }
    ...
    public async Task<Result<IssuedWithholdingDto?>> Handle(
        GetWithholdingByPurchaseQuery q,
        CancellationToken ct
    )
    {
