...
public sealed class GenerarIssuedRetentionCommandHandler
    : IRequestHandler<GenerarIssuedRetentionCommand, Result<Guid>>
{
    ...
    private readonly ILogger<GenerarIssuedRetentionCommandHandler> _logger;

    public GenerarIssuedRetentionCommandHandler(
        ...
        ILogger<GenerarIssuedRetentionCommandHandler> logger)
    {
    ...
    public async Task<Result<Guid>> Handle(GenerarIssuedRetentionCommand command, CancellationToken ct)
    {
