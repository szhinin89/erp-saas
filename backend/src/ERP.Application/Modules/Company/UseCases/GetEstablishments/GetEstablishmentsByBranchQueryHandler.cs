    ...
    : IRequestHandler<GetEstablishmentsByBranchQuery, Result<IReadOnlyList<EstablishmentDto>>>
{
    ...
    public GetEstablishmentsByBranchQueryHandler(
    ...
    public async Task<Result<IReadOnlyList<EstablishmentDto>>> Handle(
        GetEstablishmentsByBranchQuery request,
        CancellationToken cancellationToken
    )
    {
        var items = await _repo.GetByBranchAsync(
    ...
    internal static EstablishmentDto ToDto(Domain.Modules.Company.Entities.Establishment e) =>
        new(
            e.Id,
            e.BranchId,
            e.CompanyId,
