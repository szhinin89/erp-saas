...
public sealed class EnableEmissionPointCommandHandler
    : IRequestHandler<EnableEmissionPointCommand, Result<bool>>
{
    private readonly IEmissionPointRepository _repo;
    private readonly ICurrentTenant _currentTenant;
    private readonly ICurrentUser _user;

    public EnableEmissionPointCommandHandler(
    ...
    public async Task<Result<bool>> Handle(
        EnableEmissionPointCommand command,
