...
public sealed class UpdateEmissionPointCommandValidator : AbstractValidator<UpdateEmissionPointCommand>
{
    public UpdateEmissionPointCommandValidator()
    {
        ...
        RuleFor(x => x.EmissionType)
            .IsInEnum().WithMessage("El tipo de emisión es obligatorio.");
    }
}
