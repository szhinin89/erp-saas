...
/// <summary>Genera una clave de acceso de 49 dígitos con dígito verificador válido (misma regla que <see cref="ERP.Infrastructure.Services.SriFacturaParser"/>).</summary>
internal static class ClaveAcceso49TestFactory
{
