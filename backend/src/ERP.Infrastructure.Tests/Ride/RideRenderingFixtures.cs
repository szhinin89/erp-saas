...
internal static class RideRenderingFixtures
{
    ...
    {
        public string? Resolve(string taxCode) => taxCode switch { "VAT" => "2", "ICE" => "3", _ => null };
    }

    private static InvoiceRideDocumentLayout ComposeFrom(ElectronicDocumentData data, RideBranding? branding = null)
    {
        ...
        var layout = new DefaultInvoiceRideTemplate().Compose(parseResult.Value!, branding ?? RideBranding.Empty());
    ...
    public static InvoiceRideDocumentLayout Minimal() => ComposeFrom(new ElectronicDocumentData(
        Emission: new ElectronicDocumentEmissionContext(
            "1", "1", "01", "001", "Av. Amazonas y Naciones Unidas", "001", "000000001", new DateTime(2026, 7, 1)),
        Issuer: new ElectronicDocumentIssuerData(
            "1790012345001", "ACME CIA LTDA", null, "Av. Amazonas y Naciones Unidas", null, true),
        Counterparty: new ElectronicDocumentCounterpartyData("05", "1710034065", "Juan Pérez", null, null),
        Details: [new ElectronicDocumentDetailLine(
            "SKU-001", "Producto", 1m, 10m, 0m, 10m,
    ...
    public static InvoiceRideDocumentLayout Full() => ComposeFrom(new ElectronicDocumentData(
        Emission: new ElectronicDocumentEmissionContext(
            "2", "1", "01", "001", "Av. Amazonas y Naciones Unidas", "001", "000000123", new DateTime(2026, 7, 8)),
        Issuer: new ElectronicDocumentIssuerData(
            "1790012345001", "ACME CIA LTDA", "ACME", "Av. Amazonas y Naciones Unidas",
            "CONTRIBUYENTE RÉGIMEN RIMPE", true),
        ...
        branding: RideBranding.Create(
            logoStoragePath: "branding/logo.png", primaryColorHex: "#112233",
            secondaryColorHex: "#445566", footerText: "Gracias por su compra"));

    /// <summary>Dos tarifas de IVA distintas (0% y 15%) en la misma factura — Fase 10, golden file "con IVA".</summary>
    public static InvoiceRideDocumentLayout WithMixedVatRates() => ComposeFrom(new ElectronicDocumentData(
        Emission: new ElectronicDocumentEmissionContext(
            "1", "1", "01", "001", "Av. Amazonas y Naciones Unidas", "001", "000000300", new DateTime(2026, 7, 10)),
        Issuer: new ElectronicDocumentIssuerData(
            "1790012345001", "ACME CIA LTDA", null, "Av. Amazonas y Naciones Unidas", null, true),
        Counterparty: new ElectronicDocumentCounterpartyData("05", "1710034065", "Juan Pérez", null, null),
        Details:
        [
            new ElectronicDocumentDetailLine(
                "SKU-010", "Producto gravado 0%", 3m, 5m, 0m, 15m,
                [new ElectronicDocumentDetailTax("VAT", "0", 15m, 0m, 0m)]),
            new ElectronicDocumentDetailLine(
                "SKU-011", "Producto gravado 15%", 2m, 20m, 0m, 40m,
    ...
    public static InvoiceRideDocumentLayout WithIce() => ComposeFrom(new ElectronicDocumentData(
        Emission: new ElectronicDocumentEmissionContext(
            "1", "1", "01", "001", "Av. Amazonas y Naciones Unidas", "001", "000000301", new DateTime(2026, 7, 10)),
        Issuer: new ElectronicDocumentIssuerData(
            "1790012345001", "ACME CIA LTDA", null, "Av. Amazonas y Naciones Unidas", null, true),
        Counterparty: new ElectronicDocumentCounterpartyData("05", "1710034065", "Juan Pérez", null, null),
        Details:
        [
            new ElectronicDocumentDetailLine(
                "SKU-020", "Producto con ICE", 1m, 100m, 0m, 100m,
                [
    ...
    public static InvoiceRideDocumentLayout WithAdditionalInfo() => ComposeFrom(new ElectronicDocumentData(
        Emission: new ElectronicDocumentEmissionContext(
            "1", "1", "01", "001", "Av. Amazonas y Naciones Unidas", "001", "000000302", new DateTime(2026, 7, 10)),
        Issuer: new ElectronicDocumentIssuerData(
            "1790012345001", "ACME CIA LTDA", null, "Av. Amazonas y Naciones Unidas", null, true),
        Counterparty: new ElectronicDocumentCounterpartyData(
            "05", "1710034065", "Juan Pérez", "Calle Falsa 123", "juan@example.com"),
        Details: [new ElectronicDocumentDetailLine(
            "SKU-030", "Producto", 1m, 10m, 0m, 10m,
            [new ElectronicDocumentDetailTax("VAT", "2", 10m, 15m, 1.5m)])],
        TaxSummary: [new ElectronicDocumentTaxSummary("VAT", "2", 10m, 1.5m)],
        Totals: new ElectronicDocumentTotals(10m, 0m, 1.5m, 11.5m, "USD"),
        Payments: [new ElectronicDocumentPayment("01", 11.5m, null, null)],
        ...
        [
            new ElectronicDocumentAdditionalField("Email", "cliente@example.com"),
            new ElectronicDocumentAdditionalField("Teléfono", "0999999999"),
            new ElectronicDocumentAdditionalField("Dirección de entrega", "Av. Siempre Viva 742"),
    ...
    public static InvoiceRideDocumentLayout WithMultiplePayments() => ComposeFrom(new ElectronicDocumentData(
        Emission: new ElectronicDocumentEmissionContext(
            "1", "1", "01", "001", "Av. Amazonas y Naciones Unidas", "001", "000000303", new DateTime(2026, 7, 10)),
        Issuer: new ElectronicDocumentIssuerData(
            "1790012345001", "ACME CIA LTDA", null, "Av. Amazonas y Naciones Unidas", null, true),
        Counterparty: new ElectronicDocumentCounterpartyData("05", "1710034065", "Juan Pérez", null, null),
        Details: [new ElectronicDocumentDetailLine(
            "SKU-040", "Producto", 1m, 100m, 0m, 100m,
            [new ElectronicDocumentDetailTax("VAT", "2", 100m, 15m, 15m)])],
    ...
    public static InvoiceRideDocumentLayout ManyLines(int lineCount = 8)
    {
        var details = Enumerable.Range(1, lineCount)
            .Select(i => new ElectronicDocumentDetailLine(
                $"SKU-{i:000}", $"Producto {i}", 1m, 10m, 0m, 10m,
                [new ElectronicDocumentDetailTax("VAT", "2", 10m, 15m, 1.5m)]))
            .ToList();
        ...
        return ComposeFrom(new ElectronicDocumentData(
            Emission: new ElectronicDocumentEmissionContext(
                "1", "1", "01", "001", "Av. Amazonas y Naciones Unidas", "001", "000000200", new DateTime(2026, 7, 9)),
            Issuer: new ElectronicDocumentIssuerData(
                "1790012345001", "ACME CIA LTDA", null, "Av. Amazonas y Naciones Unidas", null, true),
            Counterparty: new ElectronicDocumentCounterpartyData("05", "1710034065", "Juan Pérez", null, null),
            Details: details,
