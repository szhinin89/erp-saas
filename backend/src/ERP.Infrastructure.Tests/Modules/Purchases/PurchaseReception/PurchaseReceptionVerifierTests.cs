...
public sealed class PurchaseReceptionVerifierTests
{
    ...
    private static PurchaseReceptionRecord Record(
    ...
    private static (
        ...
        Mock<IPurchaseInvoiceRepository> purchase,
    ...
    public async Task VerifyAsync_returns_Pending_when_supplier_exists_but_purchase_does_not()
    {
        ...
        purchase
            .Setup(r =>
                r.GetByAccessKeyAsync(TenantId, It.IsAny<string>(), It.IsAny<CancellationToken>())
            )
