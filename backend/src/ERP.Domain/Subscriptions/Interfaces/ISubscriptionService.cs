...
public interface ISubscriptionService
{
    ...
    /// </summary>
    Task<bool> CheckLimitAsync(Guid subscriberId, string featureCode, long amount = 1, CancellationToken ct = default);
    ...
    /// </summary>
    Task<bool> IncrementUsageAsync(Guid subscriberId, string featureCode, long amount = 1, CancellationToken ct = default);
}
