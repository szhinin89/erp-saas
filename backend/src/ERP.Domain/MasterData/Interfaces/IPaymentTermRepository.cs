...
{
    Task<IReadOnlyList<PaymentTerm>> ListAsync(Guid tenantId, string? search = null, CancellationToken cancellationToken = default);
    Task<PaymentTerm?> GetByIdAsync(Guid tenantId, Guid id, CancellationToken cancellationToken = default);
