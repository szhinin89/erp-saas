...
public interface ISriCatalogLookupRepository
{
    ...
    Task<IReadOnlyList<SriVatRate>> GetActiveVatRatesAsync(
        DateOnly asOfDate,
        CancellationToken cancellationToken = default
    );

    Task<IReadOnlyList<SriIceRate>> GetActiveIceRatesAsync(
        CancellationToken cancellationToken = default
    );

    Task<IReadOnlyList<SriRetentionCode>> GetActiveRetentionCodesAsync(
        string? taxType,
        CancellationToken cancellationToken = default
    );
    ...
    Task<IReadOnlyList<SriPaymentMethod>> GetActivePaymentMethodsAsync(
        CancellationToken cancellationToken = default
    );
    ...
    Task<IReadOnlyList<SriTaxRegime>> GetActiveTaxRegimesAsync(
        CancellationToken cancellationToken = default
    );
    ...
    Task<IReadOnlyList<BarcodeTypeDefinition>> GetActiveBarcodeTypesAsync(
        CancellationToken cancellationToken = default
    );

    Task<IReadOnlyList<ItemMarginStatusDefinition>> GetItemMarginStatusesAsync(
        CancellationToken cancellationToken = default
    );

    Task<IReadOnlyList<SriIdType>> GetSriIdTypesAsync(
        CancellationToken cancellationToken = default
    );

    Task<IReadOnlyList<SriIdType>> GetSriIdTypesByUsageAsync(
