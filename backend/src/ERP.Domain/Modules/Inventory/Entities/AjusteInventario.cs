...
public sealed class AjusteInventario : AuditableEntity, ITenantEntity
{
    ...
    public string AdjustmentNumber => NumeroAjuste;
    public Guid WarehouseId => BodegaId;
    public string WarehouseName => BodegaNombre;
    public Guid ProductId => ProductoId;
    public string ProductName => ProductoNombre;
    public decimal AdjustmentQuantity => CantidadAjuste;
    public string AdjustmentType => TipoAjuste;
    public string Reason => Motivo;
    public string? Notes => Observaciones;
    public DateTime AdjustmentDate => FechaAjuste;
    public DateTime? ExecutedAt => FechaEjecucion;
    public Guid? ExecutedBy => EjecutadoPor;
    ...
    public void Execute(Guid userId) => Ejecutar(userId);
