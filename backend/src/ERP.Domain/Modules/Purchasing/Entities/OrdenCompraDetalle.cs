...
public sealed class OrdenCompraDetalle : AuditableEntity, ITenantEntity
{
    ...
    public Guid PurchaseOrderId => OrdenCompraId;
    public Guid ProductId => ProductoId;
    public string Description => Descripcion;
    public decimal OrderedQuantity => CantidadPedida;
    public decimal InvoicedQuantity => CantidadFacturada;
    public decimal UnitCost => PrecioUnitario;
    public decimal TaxAmount => Impuesto;
    public decimal PendingToInvoice => PendienteFacturar;
    ...
    public void AddInvoicedQuantity(decimal quantity, Guid updatedBy)
        => AgregarCantidadFacturada(quantity, updatedBy);
}
