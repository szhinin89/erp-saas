...
public sealed class OrdenCompra : AuditableEntity, ITenantEntity
{
    ...
    public string PurchaseOrderNumber => NumeroOrden;
    public Guid SupplierId => ProveedorId;
    public DateTime IssueDate => FechaEmision;
    public DateTime RequiredDate => FechaRequerida;
    ...
    public string? DeliveryAddress => DireccionEntrega;
    public Guid? TargetWarehouseId => BodegaDestinoId;
    public IReadOnlyList<OrdenCompraDetalle> Lines => Detalles;
    ...
    public void AddLine(OrdenCompraDetalle line) => AgregarDetalle(line);
    ...
    public void Send(Guid userId) => Enviar(userId);
    ...
    public void Approve(Guid userId) => Aprobar(userId);
    ...
    public void MarkPartiallyReceived(Guid userId) => MarcarRecibidaParcial(userId);
    ...
    public void Close(Guid userId) => Cerrar(userId);
}
