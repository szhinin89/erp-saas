...
public sealed class GastoFactura : MasterEntity, ITenantEntity
{
    ...
    public string? AccessKey => ClaveAcceso;
    public DateTime IssueDate => FechaEmision;
    public Guid? SupplierId => ProveedorId;
    public string? DocumentNumber => NumeroFactura;
    public string Concept => Concepto;
    public string Category => CategoriaGasto;
    public decimal TaxTotal => Impuesto;
    public string? XmlFilePath => XmlPath;
    public string? RejectionReason => MotivoRechazo;
    public Guid? JournalEntryId => AsientoContableId;
    public decimal AppliedSupplierNotesTotal => TotalNotasProveedorAplicado;
    public EstadoGasto Status => Estado;
    ...
    public void Validate(Guid userId) => Validar(userId);
    ...
    public void Approve(Guid userId, Guid journalEntryId) => Aprobar(userId, journalEntryId);
    ...
    public void RegisterAppliedSupplierNote(string noteType, decimal noteTotalAmount, Guid userId)
        => RegistrarNotaProveedorAplicada(noteType, noteTotalAmount, userId);
    ...
    public void Reject(Guid userId, string reason) => Rechazar(userId, reason);
