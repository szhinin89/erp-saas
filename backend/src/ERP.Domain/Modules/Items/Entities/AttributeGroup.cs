...
/// SubscriberId nullable: NULL = grupo global del sistema, UUID = grupo del subscriber.
/// </summary>
public sealed class AttributeGroup : MasterEntity, ISubscriberScopedEntity
{
    ...
    public static AttributeGroup Create(
        Guid subscriberId, string code, string name, int sortOrder = 0)
    {
