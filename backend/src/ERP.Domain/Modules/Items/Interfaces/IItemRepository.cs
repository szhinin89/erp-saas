...
public interface IItemRepository
{
    ...
    /// </summary>
    Task<string?> GetSupplierCodeAsync(
        Guid itemId,
        Guid supplierId,
        Guid tenantId,
        CancellationToken cancellationToken = default
    ...
    Task<Item?> ResolveByAnyCodeAsync(
        string code,
        Guid tenantId,
        CancellationToken cancellationToken = default
    );
    ...
    /// </summary>
    Task<Guid?> FindItemIdBySupplierCodeAsync(
        Guid supplierId,
        string code,
        Guid tenantId,
        CancellationToken cancellationToken = default
    ...
    Task ReplaceUnitConversionsAsync(
        Guid itemId,
        IEnumerable<ItemUnitConversion> newConversions,
        CancellationToken cancellationToken = default
    );
    Task ReplaceSubstitutesAsync(
        Guid itemId,
        IEnumerable<ItemSubstitute> newSubstitutes,
        CancellationToken cancellationToken = default
    );
    Task ReplacePackagingLevelsAsync(
        Guid itemId,
