...
public sealed class CompanyScopeException : Exception
{
    ...
    private CompanyScopeException(string code, string message) : base(message)
    {
        Code = code;
    }
    ...
    public static CompanyScopeException SubscriberInactive()
        => new("subscriber_inactive", "El suscriptor no está activo.");
}
