...
public static class SalesModule
{
    ...
    [NavItem("Documentos",
        LabelKey = "app.nav.item.sales.invoices", SortOrder = 10,
    ...
    [NavItem("Facturas de Venta", Permission = SalesPermissions.View,
        LabelKey = "app.nav.item.sales.invoices", SortOrder = 10,
    ...
    // ── Contenedor: Cobros ─────────────────────────────────────────
    [NavItem("Cobros",
        LabelKey = "app.nav.item.sales.paymentMethods", SortOrder = 20,
        Id = "e4000000-0000-4000-9000-000000000002",
        PermissionsAnyCsv = SalesPermissions.View)]
    public const string PaymentsGroup = "/sales/payments-group";

    [NavItem("Métodos de Pago", Permission = SalesPermissions.View,
        LabelKey = "app.nav.item.sales.paymentMethods", SortOrder = 10,
    ...
    [NavItem("Facturación Electrónica",
        LabelKey = "app.nav.item.settings.electronicInvoicing", SortOrder = 30,
    ...
    [NavItem("Electronic Invoicing", Permission = ElectronicInvoicingPermissions.View,
        LabelKey = "app.nav.item.settings.electronicInvoicing", SortOrder = 10,
        ParentId = "e4000000-0000-4000-9000-000000000003")]
    public const string ElectronicInvoicing = "/settings/electronic-invoicing";

    [NavItem("Electronic Documents Monitor", Permission = ElectronicDocumentsPermissions.View,
        LabelKey = "app.nav.item.electronicDocuments.monitor", SortOrder = 20,
        ParentId = "e4000000-0000-4000-9000-000000000003")]
