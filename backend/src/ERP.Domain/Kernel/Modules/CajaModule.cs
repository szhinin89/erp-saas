...
{
    [NavItem("Administración de Cajas", Permission = CajaPermissions.Manage,
        LabelKey = "app.nav.item.caja.registers", SortOrder = 5,
        Id = "f5000000-0000-4000-9000-000000000002")]
    public const string Registers = "/cash/registers";

    [NavItem("Sesiones de Caja", Permission = CajaPermissions.View,
        LabelKey = "app.nav.item.caja.sessions", SortOrder = 10,
