...
test.describe('Auth multi-tab refresh', () => {
  ...
  test('reload paralelo en dos pestañas mantiene sesión', async ({ browser }) => {
  ...
  test('logout en una pestaña cierra sesión en la otra', async ({ browser }) => {
    test.setTimeout(90_000);
    ...
    await pageA.getByRole('button', { name: /Cerrar sesión|Sign out/i }).click();
