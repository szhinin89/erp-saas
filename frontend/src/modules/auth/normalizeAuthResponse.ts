...
export function normalizeAuthResponse(raw: AuthLike): AuthResponse {
  ...
  return {
    ...
    requiresCompanySelection: pickBoolean(raw, 'requiresCompanySelection', 'RequiresCompanySelection'),
    token,
    ...
    requiresPasswordReset: pickBoolean(raw, 'requiresPasswordReset', 'RequiresPasswordReset'),
    passwordResetToken: pickString(raw, 'passwordResetToken', 'PasswordResetToken') || null,
    passwordResetTokenExpiresIn: pickNumber(raw, 'passwordResetTokenExpiresIn', 'PasswordResetTokenExpiresIn'),
  };
}
