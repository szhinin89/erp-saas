      ...
      editorContent={
        page.panelOpen ? (
          ...
          <div className="cfg-tabs-empty">
            <span className="material-symbols-outlined cfg-empty-panel__icon">receipt_long</span>
            <p className="cfg-empty-panel__title">Seleccione o cree un establecimiento</p>
            <p className="cfg-empty-panel__sub">
              Use el botón <strong>Nuevo Establecimiento</strong> en la pestaña Lista, o seleccione uno para editar.
            </p>
          </div>
        )
      }
