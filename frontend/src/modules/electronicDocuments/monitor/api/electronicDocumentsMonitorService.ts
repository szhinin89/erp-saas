...
export const electronicDocumentsMonitorService = {
  getList: (params: ElectronicDocumentsListParams) =>
    apiGet<ElectronicDocumentsListResponse>("/api/v1/electronic-documents", {
      params,
    }),

  getDashboard: () =>
    apiGet<ElectronicDocumentsDashboardDto>(
      "/api/v1/electronic-documents/dashboard",
    ),
  ...
  getTimeline: (id: string) =>
    apiGet<ElectronicDocumentTimelineEventDto[]>(
      `/api/v1/electronic-documents/${id}/timeline`,
    ),
  ...
  getXml: (
    sourceModule: string,
    sourceEntityId: string,
    variant: ElectronicDocumentXmlVariant,
  ) =>
  ...
  retryNow: (id: string) =>
    apiPost<ElectronicDocumentDetailDto>(
      `/api/v1/electronic-documents/${id}/retry`,
      {},
    ),
