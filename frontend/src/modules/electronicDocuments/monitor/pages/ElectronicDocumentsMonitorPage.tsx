...
export function ElectronicDocumentsMonitorPage() {
  ...
  if (!m.canView)
    return <NoAccessPage title={t("electronicDocuments.monitor.title")} />;
  ...
  return (
    <ErpPageTemplate
      ...
      action={
        <ZHBtn
          variant="secondary"
          type="button"
          disabled={m.listLoading || m.dashboardLoading}
          onClick={m.refresh}
        >
    ...
    >
      {m.dashboardError && (
        <ZHPageNotice
          variant="error"
          message={t("electronicDocuments.monitor.dashboard.loadError")}
          detail={m.dashboardError}
        />
      )}
      ...
      <div className="pg-section">
        ...
        {m.listError && (
          <ZHPageNotice
            variant="error"
            message={t("electronicDocuments.monitor.table.loadError")}
            detail={m.listError}
          />
        )}
