 ...
 * - Validación / tipo de formulario: `customerFormSchema`, `CustomerFormValues` desde `schemas/catalog/customerSchema`
 ...
 * 1. `useForm({ resolver: zodResolver(customerFormSchema), defaultValues: emptyCustomerForm() })`
 * 2. Opcional: `reset(customerFormFromDto(clienteSeleccionado))` al elegir cliente existente
 * 3. Tras validar: `customerService.create(customerFormToApiBody(data))` o update según negocio
 *
