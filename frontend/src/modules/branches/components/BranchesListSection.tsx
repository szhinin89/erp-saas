      ...
      <div className="pg-section">
        <div className="pg-section-header">
          ...
          <div className="br-actions-tight">
            ...
            {canCreate && (
              <ZHBtn variant="primary" size="sm" type="button" onClick={openCreate}>
              ...
              <tbody>
                {filtered.map((row) => (
                  ...
                  >
                    ...
                    <td>
                      <div className="br-list-contact">{row.address || <span className="subtle">—</span>}</div>
                    </td>
        ...
        <div className="pg-table-footer">
          <p className="subtle br-list-footer-note">{filtered.length} sucursales</p>
          {items.length > 0 && (
