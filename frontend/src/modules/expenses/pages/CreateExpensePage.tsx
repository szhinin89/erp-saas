...
import { expensesService, type ExpenseCategoryDto } from '../api/expensesService';
...
export function CrearGastoPage() {
  ...
  const categoriasState = useCompanyScopedAsync(() => expensesService.getCategorias());
  ...
  const handleSubmit = async () => {
    ...
    setSaving(true);
    try {
      await expensesService.createManual({
