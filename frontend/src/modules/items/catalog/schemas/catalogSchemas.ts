...
export const emptyAttributeGroupForm = (): AttributeGroupFormValues => ({
  code: "",
  name: "",
  sortOrder: 0,
});
...
>;
export type AttributeDefinitionFormInput = z.input<
  typeof attributeDefinitionSchema
>;
export const emptyAttributeDefinitionForm =
