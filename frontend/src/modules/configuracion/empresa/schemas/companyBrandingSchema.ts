...
export const companyBrandingSchema = z.object({
  primaryColor: z.string().regex(HEX_COLOR_REGEX, 'Color hexadecimal inválido').optional().or(z.literal('')),
  secondaryColor: z.string().regex(HEX_COLOR_REGEX, 'Color hexadecimal inválido').optional().or(z.literal('')),
