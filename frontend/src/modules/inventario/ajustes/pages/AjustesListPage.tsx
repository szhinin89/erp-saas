        ...
        {loading ? (
          ...
          <>
            <table className="table">
              ...
              <tbody>
                {items.map((a) => (
                  <tr key={a.id} style={{ cursor: 'pointer' }} onClick={() => navigate(`/inventario/ajustes/${a.id}`)}>
                    <td><strong>{a.numeroAjuste}</strong></td>
                    <td>{a.productoNombre}</td>
                    <td>{a.bodegaNombre}</td>
                    <td><AjusteTipoBadge tipo={a.tipoAjuste} cantidad={Math.abs(a.cantidadAjuste)} /></td>
                    <td>{a.motivo}</td>
                    <td>{new Date(a.fechaAjuste).toLocaleDateString()}</td>
                    <td><AjusteEstadoBadge estado={a.estado} /></td>
                    <td>
