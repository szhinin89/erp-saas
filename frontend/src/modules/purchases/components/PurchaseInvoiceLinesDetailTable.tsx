...
export function PurchaseInvoiceLinesDetailTable({ lines }: Readonly<Props>) {
  ...
  const columns: ZHDataTableColumn<PurchaseLineDto>[] = [
    ...
    },
    {
      ...
      align: "right",
      cellClassName: "zh-table-cell--num",
      render: (line) => <ZHMoneyValue precision="purchaseUnitPrice" value={line.unitPrice} currencySymbol="" align="end" />,
    },
    {
      key: "discount",
      ...
      align: "right",
      cellClassName: "zh-table-cell--num",
      render: (line) => <ZHMoneyValue precision="money" value={line.discountAmount} currencySymbol="" align="end" />,
    },
    {
      key: "taxableBase",
      ...
      align: "right",
      cellClassName: "zh-table-cell--num",
      render: (line) => <ZHMoneyValue precision="money" value={line.taxableBase} currencySymbol="" align="end" />,
    },
    {
      key: "vat",
      ...
      align: "right",
      cellClassName: "zh-table-cell--num",
      render: (line) => <ZHMoneyValue precision="tax" value={line.vatAmount} currencySymbol="" align="end" />,
    },
    {
      key: "ice",
      ...
      align: "right",
      cellClassName: "zh-table-cell--num",
      render: (line) => <ZHMoneyValue precision="tax" value={line.iceAmount} currencySymbol="" align="end" />,
    },
    {
      key: "irbpnr",
      ...
      align: "right",
      cellClassName: "zh-table-cell--num",
      render: (line) => <ZHMoneyValue precision="tax" value={line.irbpnrAmount} currencySymbol="" align="end" />,
    },
    {
      key: "total",
      ...
      align: "right",
      cellClassName: "zh-table-cell--num",
      render: (line) => <ZHMoneyValue precision="money" value={line.taxInclusiveTotal} currencySymbol="" align="end" />,
    },
    {
      key: "warehouse",
