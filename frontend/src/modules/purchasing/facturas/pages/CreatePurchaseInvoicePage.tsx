...
import { purchaseInvoicesService, type PurchaseInvoiceLineInput } from '../api/purchaseInvoicesService';
...
export function CrearCompraPage() {
  ...
  const handleSubmit = async () => {
    ...
    const lines: PurchaseInvoiceLineInput[] = lineas.map((l) => ({
    ...
    setSaving(true);
    try {
      await purchaseInvoicesService.createManual({
        businessPartnerId,
