...
import { auditActionBadge, parseAuditLine } from './platformMenuBuilderUtils';

export type PlatformMenuBuilderCrmAuditSectionProps = {
  auditLines: string[];
...
export function PlatformMenuBuilderCrmAuditSection({
  auditLines,
  setAuditLines,
  ...
  onTriggerImport,
  onImportFile,
}: PlatformMenuBuilderCrmAuditSectionProps) {
  return (
