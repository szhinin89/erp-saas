...
import type { CrmLocalPlan } from './platformMenuBuilderUtils';
...
export type PlatformMenuBuilderCrmModalsProps = {
...
export function PlatformMenuBuilderCrmModals({
...
}: PlatformMenuBuilderCrmModalsProps) {
  return (
    <>
      {resetPlanConfirmOpen ? (
        <ZHConfirmModal
