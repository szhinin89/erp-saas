    ...
    <>
      <div className="edm-xml-actions">
        ...
        <ZHBtn
          ...
          size="sm"
          type="button"
          disabled={!xmlAuthorizedAvailable}
      ...
      {xmlError && (
        <ZHPageNotice
          variant="error"
          message={t("electronicDocuments.monitor.detail.xmlLoadError")}
          detail={xmlError}
        />
      )}
          ...
          <div className="edm-xml-viewer-header">
            ...
            <ZHBtn
              ...
              onClick={() =>
                downloadTextFile(
                  xmlContent,
                  `${downloadFileBaseName}-${xmlVariant.toLowerCase()}.xml`,
                )
              }
            >
