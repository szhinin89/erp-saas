...
export function ElectronicDocumentTechnicalInfo({ technicalInfo }: Props) {
  ...
  const rows: Array<[string, string | null]> = [
    [
      t("electronicDocuments.diagnostic.technicalInfoAccessKey"),
      technicalInfo.accessKey,
    ],
    [
      t("electronicDocuments.diagnostic.technicalInfoAuthorizationNumber"),
      technicalInfo.authorizationNumber,
    ],
    [
      t("electronicDocuments.diagnostic.technicalInfoEnvironment"),
      technicalInfo.environment,
    ],
    [
      t("electronicDocuments.diagnostic.technicalInfoAuthorizationDate"),
      technicalInfo.authorizationDate
        ? formatDateTime(technicalInfo.authorizationDate)
        : null,
    ],
    [
      t("electronicDocuments.diagnostic.technicalInfoRetryCount"),
      String(technicalInfo.retryCount),
    ],
    [
      t("electronicDocuments.diagnostic.technicalInfoLastAttempt"),
      technicalInfo.lastAttemptUtc
        ? formatDateTime(technicalInfo.lastAttemptUtc)
        : null,
    ],
    [
      t("electronicDocuments.diagnostic.technicalInfoCorrelationId"),
      technicalInfo.correlationId,
    ],
  ];
