  ...
  return (
    <div className="rpt-filters">
      ...
      <div className="rpt-filters-actions">
        <button type="button" className="zh-btn zh-btn--ghost zh-btn--md" onClick={onClear}>
          {clearLabel}
        </button>
        <button type="button" className="zh-btn zh-btn--primary zh-btn--md" onClick={onApply}>
          {applyLabel}
        </button>
      </div>
    </div>
    ...
    <div className="pg-section">
      <div className="pg-table-controls">
        <div className="pg-table-controls-left">
          ...
          <button type="button" className="zh-btn zh-btn--ghost zh-btn--md rpt-filter-btn" aria-label="Filtros">
        ...
        <div className="pg-table-controls-right">
          {showing && total !== undefined && (
            <span>
              Mostrando {showing} de {total.toLocaleString()}
            </span>
          )}
...
export function ReportStatusBadge({
  ...
  const colorMap: Record<RptStatusTone, string> = {
    success: 'badge--green', info: 'badge--blue', warning: 'badge--orange',
    error: 'badge--red', neutral: 'badge--gray',
  };
  return <span className={`badge badge--md ${colorMap[tone]}`}>{label}</span>;
}
