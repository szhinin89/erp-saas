...
import type { CommercialPlanAdmin, SuperAdminSubscriber } from '../../modules/superadmin/api/superAdminService';
import { goToCompaniesSubscriberDetail } from '../../navigation/companiesSubscriberDetailNav';
import { formatPlanMoney, monthlyEquivalentPrice, planVisualTier } from './superAdminPlansSectionUtils';

type Props = {
  plans: CommercialPlanAdmin[];
  planByCode: Map<string, CommercialPlanAdmin>;
  filteredTenants: SuperAdminSubscriber[];
...
export function SuperAdminPlansSectionSubscribers({
  plans,
  planByCode,
  filteredTenants,
  subscriberSearch,
