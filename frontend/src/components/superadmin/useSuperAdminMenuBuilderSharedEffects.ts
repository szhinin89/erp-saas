...
import { superAdminService, type CommercialPlanAdmin } from '../../modules/superadmin/api/superAdminService';
...
import type { EditorMainTab } from './superAdminMenuBuilderUtils';
...
export function useSuperAdminMenuBuilderSharedEffects(params: SuperAdminMenuBuilderSharedEffectsParams): void {
  const {
    crmWorkspace,
    planId,
    plans,
