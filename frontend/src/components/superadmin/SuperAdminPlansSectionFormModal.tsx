...
import type { PlanFormState } from './superAdminPlansSectionUtils';
...
export function SuperAdminPlansSectionFormModal({ mode, planForm, setPlanForm, busy, t, onClose, onSave }: Props) {
  return (
    <Modal
      onClose={onClose}
      size="lg"
