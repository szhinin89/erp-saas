...
import { buildCrmComposerPanels } from './SuperAdminMenuBuilderCrmComposerPanels';
import { SuperAdminMenuBuilderCrmPreviewSection } from './SuperAdminMenuBuilderCrmPreviewSection';
import { SuperAdminMenuBuilderCrmAuditSection } from './SuperAdminMenuBuilderCrmAuditSection';
import { SuperAdminMenuBuilderCrmModals } from './SuperAdminMenuBuilderCrmModals';
import { useSuperAdminMenuBuilderCrmWorkspaceHandlers } from './useSuperAdminMenuBuilderCrmWorkspaceHandlers';
import type { UseSuperAdminMenuBuilderReturn } from './useSuperAdminMenuBuilder';

export type SuperAdminMenuBuilderCrmWorkspaceProps = UseSuperAdminMenuBuilderReturn;

export function SuperAdminMenuBuilderCrmWorkspace(props: SuperAdminMenuBuilderCrmWorkspaceProps) {
  const {
    t,
    locale,
    planId,
  ...
  const handlers = useSuperAdminMenuBuilderCrmWorkspaceHandlers({
    t,
    planId,
    setPlanId,
    setErr,
  ...
  return (
    <div className="pg-page">
      ...
      <SuperAdminMenuBuilderCrmPreviewSection
      ...
      <SuperAdminMenuBuilderCrmAuditSection
      ...
      <SuperAdminMenuBuilderCrmModals
