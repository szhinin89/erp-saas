...
export type SuperAdminMenuBuilderLegacyPanelProps = UseSuperAdminMenuBuilderReturn;

export function SuperAdminMenuBuilderLegacyPanel(props: SuperAdminMenuBuilderLegacyPanelProps) {
  const {
    t,
    sub,
    setSub,
