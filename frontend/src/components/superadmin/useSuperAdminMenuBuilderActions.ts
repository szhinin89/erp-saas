...
import { buildPersistableMenuJson } from './superAdminMenuBuilderPersist';
...
export function useSuperAdminMenuBuilderActions(params: SuperAdminMenuBuilderActionsParams) {
  const {
    crmWorkspace,
    t,
    planId,
