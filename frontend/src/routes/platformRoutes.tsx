...
/**
 * Platform Control Plane UI — única fuente de verdad de rutas `/superadmin/*`.
 * Shell fuera de `AppLayout`; bookmarks `/companies/*` redirigen aquí.
 */
export function platformShellRoutes() {
  return (
    <Route path="/superadmin" element={<PlatformLayout />}>
      ...
      <Route path="navigation-menu" element={<Navigate to="/superadmin/plans?tab=menu" replace />} />
