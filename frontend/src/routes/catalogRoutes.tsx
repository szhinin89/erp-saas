...
export const catalogRoutes = [
  ...
  <Route key="admin-access-sessions" path="/admin/access/sessions" element={<AdminUserSessionsPage />} />,
  ...
  <Route key="purchase-reception" path="/purchases/reception" element={<PurchaseReceptionPage />} />,

  // -- Sales ---------------------------------------------------------------
  <Route key="sales" path="/sales" element={<SalesPage />} />,
  <Route key="sales-payment-methods" path="/sales/payment-methods" element={<PaymentMethodsPage />} />,

  // -- Caja (Cash Management) ---------------------------------------------
  <Route key="cash" path="/cash" element={<CajaPage />} />,
  <Route key="cash-registers" path="/cash/registers" element={<CashRegistersPage />} />,

  // -- Finance ------------------------------------------------------------
  <Route key="finance-credit-terms" path="/finance/credit-terms" element={<CreditTermsPage />} />,

  // -- MasterData / Payment Terms -----------------------------------------
  <Route key="master-payment-terms" path="/master/payment-terms" element={<PaymentTermsPage />} />,

  // -- Catalog ------------------------------------------------------------
  <Route key="catalog-brands" path="/catalog/brands" element={<BrandsPage />} />,
  <Route key="catalog-attribute-groups" path="/catalog/attribute-groups" element={<AttributeGroupsPage />} />,
  <Route key="catalog-attribute-definitions" path="/catalog/attribute-definitions" element={<AttributeDefinitionsPage />} />,
  <Route key="catalog-tree" path="/catalog/tree" element={<TreeEditorPage />} />,
];
