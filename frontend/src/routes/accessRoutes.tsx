...
const UsersPage = lazyNamedPage(() => import('../modules/access/users/pages/UsersPage'), 'UsersPage');
...
export const accessRoutes = [
  ...
  <Route key="access-users-new" path="/access/users/new" element={<UserConfigPage />} />,
  <Route key="access-users-detail" path="/access/users/:userId" element={<UserConfigPage />} />,
  <Route key="admin-users-legacy" path="/admin/users" element={<Navigate to="/access/users" replace />} />,
