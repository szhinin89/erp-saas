...
>
> **NO representa la arquitectura actual del ERP.** El Billing/Subscription Engine descrito aquí fue excluido permanentemente del ERP Core (ver [`ERP_CORE_FREEZE.md`](../../ERP_CORE_FREEZE.md) — "Excluidos permanentemente del ERP Core: vive en Platform, repositorio futuro separado").
>
