...
>
> **NO representa la arquitectura actual del ERP.** El "SuperAdmin Menu Builder" (`smp-*`/`smb-*`, `MenuPreview`) descrito aquí fue eliminado del código (Fase 1 Cleanup, 2026-06).
>
