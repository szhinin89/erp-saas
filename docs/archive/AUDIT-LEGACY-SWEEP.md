...
>
> **NO representa la arquitectura actual del ERP.** Referencia componentes y rutas (`PlatformPanelPage`, `PlatformOverviewPage`, `PlatformSubscribersPage`, etc.) que no existen en el código actual.
>
