...
- `/api/subscribers/` — Control Plane SaaS eliminado permanentemente del ERP Core (ver [`ERP_CORE_FREEZE.md`](../../ERP_CORE_FREEZE.md)); debe fallar si aparece
...
**FAIL** si un endpoint literal en frontend no cae en la allowlist o coincide con prefijos prohibidos (incluye `/api/subscribers/*`, ver "Patrones prohibidos").
