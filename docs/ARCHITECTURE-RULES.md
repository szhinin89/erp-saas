...
**Relacionados (descriptivos, no sustitutos):** [ARCHITECTURE.md](./ARCHITECTURE.md), [DEVELOPMENT.md](./DEVELOPMENT.md), [IDENTITY.md](./IDENTITY.md), [DATABASE.md](./DATABASE.md), `CLAUDE.md`, `.cursor/rules/`.
...
| 2 | Este documento (`ARCHITECTURE-RULES.md`) | Diseño e implementación |
| 3 | `.cursor/rules/*.mdc` por área | Detalle operativo |
| 4 | [ARCHITECTURE.md](./ARCHITECTURE.md) | Contexto y diagramas |
