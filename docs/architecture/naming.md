...
| Retirado | `Subscriber`, `subscriber_id` → usar `Tenant`/`tenant_id` (consolidación FASE 4, ver [`docs/ARCHITECTURE.md`](../ARCHITECTURE.md#jerarquía-multiempresa)) |
...
Jerarquía CSS: [FRONTEND-RULES.md](./frontend.md#css--jerarquía-de-3-niveles).
