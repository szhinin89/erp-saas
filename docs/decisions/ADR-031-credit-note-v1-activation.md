...
Detalle de la implementación funcional completa de SalesReturn/CreditNote (Fases 1-10): ver `docs/archive/plans/P0-01_SALES_RETURN_IMPLEMENTATION_PLAN.md` y `docs/archive/designs/P0-01_SALES_RETURN_CREDIT_NOTE_DESIGN.md` (archivados, Bloque 16C). RIDE de Nota de Crédito (Fase 12) y prueba real contra el SRI quedan como trabajo posterior, no bloqueante para este cierre.
