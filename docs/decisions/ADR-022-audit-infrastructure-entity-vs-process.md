...
> ejecutables completas en [docs/architecture/audit-infrastructure.md](../../docs/architecture/audit-infrastructure.md).
...
detalle operativo completo en `docs/architecture/audit-infrastructure.md`.
...
- Ningún dominio futuro necesita diseñar su propia estrategia de auditoría desde
  cero — solo sigue el checklist de la sección 2 de `docs/architecture/audit-infrastructure.md`.
...
- La primera implementación real de Process Audit debe seguir exactamente el
  ...
  `docs/architecture/audit-infrastructure.md` con el primer ejemplo concreto — sin abrir
...
2. **`AuditActor` confirmado como único modelo oficial del actor** — ver regla
   ...
   `docs/architecture/audit-infrastructure.md` secciones 8-9.
