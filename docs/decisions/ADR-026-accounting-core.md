...
- `STATUS.md` ya documenta que la implementación real fue eliminada en FASE 1 (2026-06-05); el archivo de interfaz es el único residuo pendiente de limpieza.
