...
**Documento histórico relacionado:** [docs/archive/LEGACY-DROP-READINESS.md](../archive/LEGACY-DROP-READINESS.md) — criterios y checklist (ya ejecutado) para eliminar tablas legacy.
