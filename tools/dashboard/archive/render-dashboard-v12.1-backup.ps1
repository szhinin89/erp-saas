...
Write-Host " Dashboard Renderer v12.1"
Write-Host "==============================================" -ForegroundColor Cyan
Write-Host ""
...
<td>
$($architecture.Layers.Domain.Files)
</td>
</tr>
...
<td>
$($architecture.Layers.Application.Files)
</td>
</tr>
...
<td>
$($architecture.Layers.Infrastructure.Files)
</td>
</tr>
...
<p>
Detected findings requiring engineering review.
</p>
...
<title>
ZH Technologies ERP Engineering Dashboard v12.1
</title>
...
Write-Host ""
Write-Host "Dashboard v12.1 generated successfully." -ForegroundColor Green
Write-Host ""
