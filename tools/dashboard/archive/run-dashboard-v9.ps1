...
Write-Host " ZH ERP Engineering Dashboard v9"
Write-Host "==============================================" -ForegroundColor Cyan
Write-Host ""
...
Run-Step "analyze-technical-debt.ps1"

Run-Step "analyze-security.ps1"
...
Run-Step "build-dashboard-v9.ps1"

Run-Step "render-dashboard-v9.ps1"
...
Write-Host " Dashboard v9 completed successfully"
Write-Host "==============================================" -ForegroundColor Green
