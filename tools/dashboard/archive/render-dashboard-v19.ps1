# =============================================================================
# ZH Technologies
# Progress Dashboard v19
# Engineering Health Report Renderer
#
# Evoluciona v18 (sin modificarlo) agregando la seccion "Architecture & Domains":
# conecta el modelo de dominio real (layers.json / domains.json / modules.json)
# con las metricas de ingenieria ya existentes, siguiendo la jerarquia
# PROGRESS.html -> Arquitectura -> Dominios -> Modulos -> Metricas -> Decision.
#
...
#
# Prerequisito: correr tools/dashboard/analyze-modules.ps1 antes de este
# script para generar/actualizar docs/ProgressDashboard/data/modules.json.
# =============================================================================
...
Write-Host " Dashboard Renderer v19"
Write-Host "==============================================" -ForegroundColor Cyan
Write-Host ""
...
"<html>",
"<head>",
"<title>ZH Technologies ERP Engineering Dashboard v19</title>",
...
$technicalDebtTrendHtml,
$releaseRecommendationHtml,
"<h1>ZH Technologies ERP Engineering Dashboard v19</h1>",
...
Write-Host ""
Write-Host "Dashboard v19 generated successfully." -ForegroundColor Green
Write-Host $Output
