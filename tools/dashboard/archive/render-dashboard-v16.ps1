...
Write-Host "ProductionGate HTML CONTENT:"
Write-Host $productionGateHtml

$html = @(
    Write-Host "HTML ARRAY TEST:"
Write-Host $productionGateHtml
"<!DOCTYPE html>",
"<html>",
"<head>",
"<title>ZH Technologies ERP Engineering Dashboard v16</title>",
...
$summaryHtml,
$productionGateHtml,
"<h1>ZH Technologies ERP Engineering Dashboard v16</h1>",
