...
**Baseline:** `architecture-v1.0` · **Fuente de verdad:** [`SYSTEM_TRUTH.md`](SYSTEM_TRUTH.md)
...
| G-O05 | Multi-tenant: **`SubscriberId`** en queries; empresa operativa vía **`CompanyId`** cuando aplique | ADR-004 |
...
3. ¿Cambió estructura raíz del monorepo? → requiere actualización `SYSTEM_TRUTH.md` + release note
...
Antes de implementar: leer **`SYSTEM_TRUTH.md`** + **`CLAUDE.md`**.  
