...
**ADR:** [docs/adr/ADR-022-audit-infrastructure-entity-vs-process.md](../docs/adr/ADR-022-audit-infrastructure-entity-vs-process.md)

Complementa [EVENT-DRIVEN-RULES.md](./EVENT-DRIVEN-RULES.md) (de donde esta infraestructura consume el pipeline de domain events/Outbox ya congelado) y [CORE-ARCHITECTURE.md](./CORE-ARCHITECTURE.md).
...
| Documento | Tema |
|---|---|
| [EVENT-DRIVEN-RULES.md](./EVENT-DRIVEN-RULES.md) | Domain Events / Outbox que esta infraestructura consume |
...
| [ADR-022](../docs/adr/ADR-022-audit-infrastructure-entity-vs-process.md) | Decisión de cierre Entity Audit + diseño Process Audit |
